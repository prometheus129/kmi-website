...
export const FORM_ENDPOINTS = {
  ...
  // Co-development pilot applications — shares contact endpoint until dedicated form created.
  // Submissions tagged with _formtype=codev-pilot for filtering. Includes
  // applicant-type (brand / OEM / designer-agency / other), vertical, pain
  // description, and timeline so David can prioritize the high-fit applications.
  // TODO: Create dedicated Formspree form for pilot applications →
  // replace this endpoint ID.
  codev: "https://formspree.io/f/mreynawg",
};
