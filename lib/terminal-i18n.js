...
const translations = {
  ...
  ar: {
    ...
    form: {
      ...
      messagingAppPlaceholder: "مثل واتساب",
      cta: "اشترك — مجاناً",
  ...
  bn: {
    ...
    form: {
      ...
      lastName: "পদবি *",
      lastNamePlaceholder: "আপনার পদবি",
      company: "কোম্পানির নাম *",
      companyPlaceholder: "আপনার কোম্পানি",
      country: "দেশ *",
      countryPlaceholder: "যেমন বাংলাদেশ",
      grades: "আগ্রহের পলিমার গ্রেড (ঐচ্ছিক)",
      phone: "ফোন / হোয়াটসঅ্যাপ (ঐচ্ছিক)",
      phonePlaceholder: "+880 xxxx xxxxxx",
      messagingApp: "মেসেজিং অ্যাপ",
      messagingAppPlaceholder: "যেমন WhatsApp",
  ...
  ur: {
    ...
    form: {
      ...
      messagingApp: "میسجنگ ایپ",
      messagingAppPlaceholder: "مثلاً WhatsApp",
      cta: "سبسکرائب — مفت",
