...
const translations = {
  ...
  id: {
    ...
    showcase: {
      ...
      pillars: [
        ...
        },
        {
          ...
          desc: 'Sinyal BELI / TAHAN / TUNGGU untuk 7–14 hari ke depan. Pemasok Anda saat ini tidak pernah bilang "tunggu." Kantor Materials bilang — karena insentif kami adalah hasil Anda, bukan transaksi.',
        },
        {
    ...
    sample: {
      ...
      title: "Tampilan Morning Terminal",
      ...
      marketContext:
        "PE menguat karena pengurangan output Sinopec dan kemacetan pelabuhan Nansha. PP stabil dengan margin CTO/MTO tertekan — pantau potensi destocking produsen pertengahan minggu. PA6 tertekan oleh permintaan hilir yang lemah di sektor tekstil.",
    ...
    form: {
      label: "BERLANGGANAN",
      title: "Dapatkan Morning Terminal",
      ...
      successBody:
        "Morning Terminal pertama Anda akan tiba dalam 24 jam. Kami akan menghubungi Anda untuk mengonfirmasi preferensi grade dan saluran pesan pilihan Anda.",
    },
  },
  ...
  es: {
    ...
    sample: {
      ...
      title: "C\u00f3mo se ve un Morning Terminal",
      ...
      marketContext:
        "PE al alza por reducci\u00f3n de output de Sinopec y congesti\u00f3n en puerto de Nansha. PP estable con m\u00e1rgenes CTO/MTO comprimidos \u2014 atentos al destocking de productores a mitad de semana. PA6 bajo presi\u00f3n por d\u00e9bil demanda downstream en sector textil.",
    ...
    form: {
      label: "SUSCR\u00cdBETE",
      title: "Obt\u00e9n el Morning Terminal",
      ...
      successBody:
        "Tu primer Morning Terminal llegar\u00e1 en 24 horas. Nos comunicaremos para confirmar tus preferencias de grades y canal de mensajer\u00eda preferido.",
    },
  },
  ...
  pt: {
    ...
    sample: {
      ...
      title: "Como \u00e9 um Morning Terminal",
      ...
      marketContext:
        "PE em alta com redu\u00e7\u00e3o de produ\u00e7\u00e3o da Sinopec e congestionamento no porto de Nansha. PP est\u00e1vel com margens CTO/MTO comprimidas \u2014 acompanhe poss\u00edvel destocking de produtores no meio da semana. PA6 sob press\u00e3o por demanda fraca downstream no setor t\u00eaxtil.",
    ...
    form: {
      label: "ASSINE",
      title: "Receba o Morning Terminal",
      ...
      successBody:
        "Seu primeiro Morning Terminal chegar\u00e1 em 24 horas. Entraremos em contato para confirmar suas prefer\u00eancias de grades e canal de mensagens preferido.",
    },
  },
  ...
  th: {
    ...
    sample: {
      ...
      title: "Morning Terminal \u0e21\u0e35\u0e2b\u0e19\u0e49\u0e32\u0e15\u0e32\u0e2d\u0e22\u0e48\u0e32\u0e07\u0e44\u0e23",
      ...
      marketContext:
        "PE \u0e41\u0e02\u0e47\u0e07\u0e15\u0e31\u0e27\u0e08\u0e32\u0e01 Sinopec \u0e25\u0e14\u0e01\u0e33\u0e25\u0e31\u0e07\u0e01\u0e32\u0e23\u0e1c\u0e25\u0e34\u0e15\u0e41\u0e25\u0e30\u0e17\u0e48\u0e32\u0e40\u0e23\u0e37\u0e2d Nansha \u0e41\u0e2d\u0e2d\u0e31\u0e14 PP \u0e17\u0e23\u0e07\u0e15\u0e31\u0e27\u0e42\u0e14\u0e22\u0e21\u0e32\u0e23\u0e4c\u0e08\u0e34\u0e19 CTO/MTO \u0e16\u0e39\u0e01\u0e1a\u0e35\u0e1a \u2014 \u0e15\u0e34\u0e14\u0e15\u0e32\u0e21\u0e01\u0e32\u0e23\u0e23\u0e30\u0e1a\u0e32\u0e22\u0e2a\u0e15\u0e47\u0e2d\u0e01\u0e01\u0e25\u0e32\u0e07\u0e2a\u0e31\u0e1b\u0e14\u0e32\u0e2b\u0e4c PA6 \u0e16\u0e39\u0e01\u0e01\u0e14\u0e14\u0e31\u0e19\u0e08\u0e32\u0e01\u0e2d\u0e38\u0e1b\u0e2a\u0e07\u0e04\u0e4c\u0e1b\u0e25\u0e32\u0e22\u0e17\u0e32\u0e07\u0e2d\u0e48\u0e2d\u0e19\u0e43\u0e19\u0e20\u0e32\u0e04\u0e2a\u0e34\u0e48\u0e07\u0e17\u0e2d",
    ...
    form: {
      ...
      successBody:
        "Morning Terminal \u0e09\u0e1a\u0e31\u0e1a\u0e41\u0e23\u0e01\u0e02\u0e2d\u0e07\u0e04\u0e38\u0e13\u0e08\u0e30\u0e21\u0e32\u0e16\u0e36\u0e07\u0e20\u0e32\u0e22\u0e43\u0e19 24 \u0e0a\u0e31\u0e48\u0e27\u0e42\u0e21\u0e07 \u0e40\u0e23\u0e32\u0e08\u0e30\u0e15\u0e34\u0e14\u0e15\u0e48\u0e2d\u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e40\u0e01\u0e23\u0e14\u0e17\u0e35\u0e48\u0e04\u0e38\u0e13\u0e2a\u0e19\u0e43\u0e08\u0e41\u0e25\u0e30\u0e0a\u0e48\u0e2d\u0e07\u0e17\u0e32\u0e07\u0e01\u0e32\u0e23\u0e2a\u0e48\u0e07\u0e02\u0e49\u0e2d\u0e04\u0e27\u0e32\u0e21\u0e17\u0e35\u0e48\u0e04\u0e38\u0e13\u0e15\u0e49\u0e2d\u0e07\u0e01\u0e32\u0e23",
    },
  },
};
