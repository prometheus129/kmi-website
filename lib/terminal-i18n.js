...
const translations = {
  ...
  ru: {
    ...
    showcase: {
      ...
      pillars: [
        ...
        },
        {
          ...
          desc: "Сигналы ПОКУПАТЬ / ЖДАТЬ / ДЕРЖАТЬ на 7–14 дней. Ваш текущий поставщик никогда не скажет «подождите». Kantor Materials скажет — потому что наш интерес совпадает с вашим результатом.",
        },
        {
    ...
    sample: {
      ...
      title: "Как выглядит Morning Terminal",
    ...
    form: {
      label: "ПОДПИСКА",
      title: "Получайте Morning Terminal",
      ...
      successBody:
        "Ваш первый Morning Terminal придет в течение 24 часов. Мы свяжемся с вами для уточнения интересующих марок и предпочтительного канала связи.",
    },
  },
};
