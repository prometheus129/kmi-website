...
const UI_STRINGS = {
  en: {
    ...
    ctaTitle: "Get market intelligence by email",
    ctaDesc:
      "Grade substitution analysis, price spreads, and trade-policy events across the markets we serve. Free for importers.",
  ...
  vi: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Nhận thông tin thị trường qua email",
    ctaDesc:
  ...
  tr: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Piyasa istihbaratı e-postası alın",
    ctaDesc:
      "Fiyat güncellemeleri ve tedarik zinciri uyarıları alın. İthalatçılar için ücretsiz.",
  ...
  id: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Terima intelijen pasar via email",
    ctaDesc:
      "Terima pembaruan harga dan peringatan rantai pasokan. Gratis untuk importir.",
  ...
  es: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Reciba inteligencia de mercado por correo",
    ctaDesc:
      "Reciba actualizaciones de precios y alertas de cadena de suministro. Gratis para importadores.",
  ...
  pt: {
    ...
    colNotes: "Nota de Mercado",
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Receba inteligência de mercado por e-mail",
    ctaDesc:
      "Receba atualizações de preços e alertas de cadeia de suprimentos. Grátis para importadores.",
  ...
  th: {
    ...
    colNotes: "บันทึกตลาด",
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "รับข้อมูลตลาดทางอีเมล",
    ctaDesc:
      "รับข้อมูลราคาและการแจ้งเตือนห่วงโซ่อุปทาน ฟรีสำหรับผู้นำเข้า",
    ctaButton: "สมัครฟรี",
  ...
  ar: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "احصل على معلومات السوق عبر البريد الإلكتروني",
  ...
  ur: {
    ...
    colNotes: "مارکیٹ نوٹ",
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "ای میل پر مارکیٹ انٹیلی جنس حاصل کریں",
  ...
  bn: {
    ...
    colNotes: "বাজার নোট",
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "ইমেইলে বাজার তথ্য পান",
  ...
  ru: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Получайте рыночную аналитику по email",
  ...
  fr: {
    ...
    ctaOverline: "THE POLYMER COMPASS",
    ctaTitle: "Recevez l'intelligence marché par email",
