    ...
    <section className="bg-ticker-bg py-24 px-6 lg:px-10 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        <RevealDiv>
          ...
          <h2 className="font-serif text-3xl lg:text-[40px] font-bold text-white mb-12 lg:mb-16 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {props.map((p, i) => (
            <RevealDiv key={i} delay={i * 150}>
              <div className={`border-l-[3px] ${p.accent} p-6 lg:p-8 rounded-r-lg ${p.cardBg}`}>
