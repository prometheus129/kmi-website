    ...
    <section className="bg-ticker-bg py-24 px-6 lg:px-10 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <RevealDiv>
          ...
          <p className="font-sans text-base text-body-text leading-relaxed mb-7">
            ...
            {features.map((f, i) => (
              <div key={i} className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="font-sans text-sm text-body-text leading-snug">
                    {f.desc}
                  </div>
                </div>
              </div>
        ...
        <RevealDiv delay={200}>
          <Link href={latestArticleHref} className="block group">
            <div className="bg-cards-bg rounded-xl p-6 lg:p-8 border border-white/[0.08] shadow-[0_30px_80px_rgba(0,0,0,0.4)] transition-all duration-200 group-hover:border-teal/20 group-hover:shadow-[0_30px_80px_rgba(46,139,139,0.08)]">
              {fm ? (
                <>
                  {/* Header */}
                  <div className="flex justify-between items-center mb-4">
                    <span className="font-mono text-[11px] tracking-wider text-teal font-bold bg-teal/10 px-2 py-0.5 rounded">
                  ...
                  <div className="text-[11px] tracking-wider text-teal font-sans font-bold mb-2">
                    THE POLYMER COMPASS
                  </div>
                  ...
                  {fm.tags && fm.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-5">
                      {fm.tags.slice(0, 5).map((tag) => (
                        <span
                          key={tag}
                          className="font-mono text-[11px] tracking-wider text-teal/70 bg-teal/[0.06] border border-teal/10 px-2 py-0.5 rounded"
                        >
