    ...
    <section className="bg-navy py-20 lg:py-[100px] px-6 lg:px-10 relative overflow-hidden">
      ...
      <div className="max-w-[780px] mx-auto relative z-10">
        <RevealDiv>
          ...
          <p className="font-sans text-base lg:text-[17px] text-body-text leading-relaxed mb-3">
          ...
          <p className="font-sans text-base lg:text-[17px] text-body-text leading-relaxed mb-10">
            Here is what we do:
          </p>
        </RevealDiv>
        ...
        <RevealDiv delay={200}>
          <p className="font-sans text-base lg:text-[17px] text-body-text leading-relaxed mt-10 pt-8 border-t border-white/[0.06]">
