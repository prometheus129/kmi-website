...
cta:
  ...
  body: "Screen your testing lab against CPSC's for-cause withdrawals in about 60 seconds, and get the guided official check for the specific rule your certificate cites. CertDesk also verifies the report and the material behind it — report checks with the issuing lab, and material testing through our affiliated polymer materials lab."
  buttonLabel: "Check my lab's status"
...
For a fast first pass, the free [Lab & Test-Report Status Checker](/compliance/lab-status-checker) screens your lab against CPSC's for-cause withdrawals — including the four January 2026 labs — and walks you through the official rule-specific check below. To do it by hand:
