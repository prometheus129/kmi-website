...
| **Tỉ lệ sản lượng TQ** | ~72–75% PVC Trung Quốc | ~25–28% PVC Trung Quốc |
...
**72–75% PVC Trung Quốc là calcium carbide route.** Khi bạn mua "PVC SG-5 Trung Quốc" mà không hỏi, gần chắc chắn là calcium carbide. Đây không phải hàng kém — đây là lựa chọn phổ biến nhất thế giới cho PVC cứng công nghiệp. Nhưng nó có giới hạn mà ethylene route không có.
...
Đối với ứng dụng công nghiệp (ống, cáp, profile) — an toàn và được sử dụng rộng rãi trên toàn thế giới. 72–75% PVC Trung Quốc là calcium carbide. Đối với ứng dụng tiếp xúc thực phẩm hoặc y tế — không khuyến nghị do hàm lượng tạp chất cao hơn ethylene-route. Luôn kiểm tra COA và yêu cầu chứng nhận an toàn cho ứng dụng cụ thể.
