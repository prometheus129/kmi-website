...
**Coreia do Sul** — A YNCC suspendeu operações de cracker de nafta no final de março. A Coreia importa virtualmente toda sua nafta, e a maioria transita pelo Estreito de Ormuz ou é originária de fornecedores do Oriente Médio. Quando a nafta se torna escassa, crackers param, e as exportações coreanas de PP e PE secam — incluindo os volumes que vinham para o Brasil.
