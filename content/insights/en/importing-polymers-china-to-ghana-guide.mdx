...
faq:
  - question: "How much duty do I pay on polymer imports in Ghana?"
    answer: "Commodity polymer resins — PE, PP, PVC, PET, and polyamides (HS 3901, 3902, 3904, 3907, 3908) — attract a 5% ECOWAS CET import duty as Band 1 raw materials; a few specialty polymers (PVA, acrylics, general-purpose polystyrene) sit in the 10% band. However, the total tax burden — including VAT, NHIL, GETFund, ECOWAS levy, and EDIFL — brings the effective rate to approximately 26-29% on CIF value. There are no anti-dumping or countervailing duties in force against Chinese polymer imports into Ghana. All origins pay the same rates."
  - question: "Do I need GSA certification for plastic raw materials?"
    answer: "Yes. Ghana requires conformity assessment through the Ghana Standards Authority for imported goods, including plastic raw materials. The key requirements are: filing an Import Declaration Form (IDF) through the GNSW system before shipment, arranging pre-shipment inspection for imports above $5,000, and providing supporting documentation (COA, MSDS, Certificate of Origin). Verify current GSA requirements for your specific HS code and end-use application."
  - question: "How long does shipping from China to Tema take?"
...
Ghana applies the ECOWAS Common External Tariff (CET) to all polymer imports. The commodity and engineering polymers Ghanaian converters import — PE, PP, PVC, PET, and polyamides — are classified as Band 1 raw materials at a 5% import duty regardless of origin. A few specialty polymers (PVA, acrylics, general-purpose polystyrene) sit in the 10% band (see table).

| HS Heading | Product | CET Duty Rate | Band |
|---|---|---|---|
| 3901 | Polyethylene (PE, HDPE, LLDPE, LDPE) | 5% | Band 1 |
| 3902 | Polypropylene (PP) | 5% | Band 1 |
| 3903 | Polystyrene (PS, ABS, SAN) | 5% (general-purpose PS 3903.19: 10%) | Band 1 |
| 3904 | Polyvinyl Chloride (PVC) | 5% | Band 1 |
| 3905 | Polyvinyl acetate, other vinyl polymers | 10% | Band 2 |
| 3906 | Acrylic polymers | 10% | Band 2 |
| 3907 | Polyacetals, polyesters, PET | 5% | Band 1 |
| 3908 | Polyamides (nylon, PA6, PA66) | 5% | Band 1 |

**Important:** There is no preferential tariff arrangement between China and Ghana. AfCFTA applies only to intra-African trade. No bilateral free trade agreement exists. All origins — China, India, Middle East, Europe — pay the same 5% CET duty on commodity polymer resins (PE, PP, PVC, PET, PA).
...
Commodity polymer resins — PE, PP, PVC, PET, and polyamides (HS 3901, 3902, 3904, 3907, 3908) — attract a 5% ECOWAS CET import duty as Band 1 raw materials; a few specialty polymers (PVA, acrylics, general-purpose polystyrene) sit in the 10% band. However, the total tax burden — including VAT, NHIL, GETFund, ECOWAS levy, and EDIFL — brings the effective rate to approximately 26-29% on CIF value. There are no anti-dumping or countervailing duties in force against Chinese polymer imports into Ghana. All origins pay the same rates.
