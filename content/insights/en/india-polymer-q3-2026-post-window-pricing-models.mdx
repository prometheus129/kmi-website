...
> **Timing (June 2026):** With Notification 12/2026-Customs scheduled to sunset on **June 30, 2026** and no extension signalled, the scenarios below are no longer hypothetical — they are the Q3 sourcing decision in front of importers now. New China-origin ocean bookings can no longer beat the deadline (see the [Q2 execution guide](/insights/india-polymer-q2-2026-front-loading-bcd-window)); the live question is the post-July-1 origin mix once the 8.25% wall is restored.
...
For paste resin specifically, these are significantly better economics than Chinese origin regardless of BCD window status.
...
If the nil-BCD window under Notification No. 12/2026-Customs is not extended, Basic Customs Duty reverts to 7.5% plus Social Welfare Surcharge of 0.75% (10% of BCD) — total non-recoverable import cost returns to 8.25% of CIF value. IGST at 18% continues unchanged and remains reclaimable as input tax credit for GST-registered importers. The BIS rescission from November 12, 2025 is structural and unaffected. PVC paste anti-dumping duty from China (up to $707/MT under Notification No. 09/2024-Customs ADD) continues through June 2029 unaffected.

### Does China's CTO/MTO feedstock advantage offset the 8.25% duty reversion?

Partially. At typical crude oil prices of $60-80/bbl, CTO (Coal-to-Olefin) and MTO (Methanol-to-Olefin) routes give Chinese commodity polyolefins a structural $50-120/MT cost advantage over naphtha-route production. That translates to 4-9% of typical PE/PP CFR. The offset preserves Chinese competitiveness on commodity grades only if Chinese FOB runs roughly $30-60/MT below naphtha-route alternatives pre-duty — a condition held through Q1 2026 per ChemOrbis and S&P Global Platts data. At current elevated crude prices from the Hormuz disruption, the CTO gap widens. For standard grades (PP T30S, HDPE bimodal, LLDPE standard), Chinese landed cost stays within $20-50/MT of Korean CEPA or Thai AIFTA alternatives even at 8.25% restored BCD. For specialty grades where CTO/MTO is less dominant, China loses relative advantage.

### Which Chinese polymer grades remain economical if BCD returns to 7.5%?

Commodity polyolefins from CTO/MTO-route producers (PP homo T30S, bimodal HDPE pipe grades, LLDPE standard grades, PVC suspension via calcium carbide route) remain within $20-50/MT of best alternative at restored 8.25% BCD. Engineering polymers (PA6, PA66, PC, POM, PBT) from China remain preferred regardless of window status — with the partial exception of ABS, where India-Korea CEPA provides meaningful preferential rates on HS 3903.30. Grades that lose competitiveness at 8.25%: some high-MFI specialty grades, bottle-grade PET (Thailand AIFTA becomes competitive), and Tier 1 OEM-facing grades where Korean quality premium plus CEPA rate justifies the shift.

### What does India-Korea CEPA 2.0 offer on polymer imports?

India-Korea Comprehensive Economic Partnership Agreement (CEPA) provides preferential BCD rates on selected polymer tariff lines for Korean-origin polymers. The revised CEPA 2.0 framework in effect enforces stricter Rules of Origin — typically requiring change in tariff subheading or regional value content (RVC) threshold. Rates vary by HS code and must be verified against the current CEPA tariff schedule at the Indian Trade Portal. Korean Tier 1 producers (LG Chem, Lotte Chemical, SK Geo Centric, Hanwha) offer quality reputation for OEM-facing grades. CEPA also has meaningful preferential coverage on ABS (HS 3903.30) — relevant if shifting ABS volume away from China. Certificate of Origin must be issued by an authorized Korean agency; India enforces 'proof of origin' (not just certificate) since Circular No. 14/2025-Customs effective March 18, 2025.

### What are India-UAE CEPA preferential rates on polymers?

India-UAE CEPA imposes a Tariff Rate Quota (TRQ) structure on polymers, not simple graduated preference. LDPE qualifies for 0% BCD within an annual TRQ cap of approximately 50,000 MT per year; above-quota imports face MFN rate of 7.5% plus SWS. Most polymer lines follow similar TRQ mechanics with standard TRQ caps around 60,000 MT per line. Phased reductions over 5 years apply subject to TRQ. This matters for Q3 planning: UAE allocation must be secured early in the fiscal year; late-filing importers may find quotas exhausted and face full MFN rate. Verify quota status for your specific HS code via DGFT Public Notice for India-UAE CEPA.

### Can I route Chinese polymer through Thailand or Korea to get AIFTA or CEPA preference?

No. Indian customs enforces 'proof of origin' since Circular No. 14/2025-Customs effective March 18, 2025 — not just Certificate of Origin. Third-country routing via ASEAN or other preferential origins is being actively policed. Form AI and CEPA certificates must correspond to actual production in the claimed origin country. A container of Chinese HDPE exported through Bangkok does not automatically qualify for AIFTA 0% BCD — customs can query, reassess at MFN rate, and impose penalties. Legitimate dual-sourcing with genuine Thai or Korean producers is fine; routing via trading intermediaries is not. Note also that AIFTA Rules of Origin are under renegotiation — a 10th round was held mid-August 2025 with RoO tightening under discussion.

### What happens to the PVC paste anti-dumping duty if the BCD window closes?

Unchanged. Notification No. 09/2024-Customs ADD is a separate proceeding from BCD under different statutory authority. The duty up to $707/MT on Chinese PVC paste runs through June 2029. For alternative sourcing, Hanwha Solutions Korea (Yeosu plant) is exempt from the ADD entirely ($0/MT rate in the notification); Kaneka Paste Polymer Malaysia is exempt via an accepted price undertaking. If Q3 volume warrants a supplier shift, both are viable alternatives to Chinese paste regardless of BCD status.

### How quickly can I onboard a Korean or Thai polymer supplier if the window closes?

Realistic timelines: initial supplier contact and sample qualification typically 4-8 weeks for Tier 1 Korean (LG Chem, Lotte Chemical, SK Geo Centric, Hanwha) or Thai (SCG Chemicals, HMC Polymers) producers with India distributor networks. OEM-facing grades requiring formal requalification (approved vendor list updates at Maruti, Hyundai, Tata, Mahindra) typically 3-9 months. For Q3 sunset protection, sample qualification must be initiated by roughly May 15 — after that, supplier allocation, logistics, and documentation will not be ready for first Q3 deliveries. For OEM-qualified grades, Q3 is too late regardless; those conversations should have started in Q1.

### Are there other DGTR actions pending that could change Q3 pricing?

Yes. DGTR initiated an anti-dumping investigation on LLDPE imports from Kuwait, Malaysia, Oman, Qatar, Saudi Arabia, and UAE in July 2025. Standard investigation cycle is 12-18 months — expect provisional or final determination between Q4 2026 and Q1 2027. If duty is imposed on Gulf LLDPE, Chinese and Korean/Thai origins become the only viable alternatives for LLDPE. Separately, PP and bulk PE from China have no active anti-dumping duty confirmed as of April 2026, but DGTR investigation history includes prior PP inquiries. Monitor dgtr.gov.in quarterly.

### Should Q3 planning assume window extension or sunset?

Build both scenarios. For commodity polyolefins, run parallel landed-cost models at 0% BCD (extension) and 7.5% BCD plus 0.75% SWS (sunset) across China, Korea, Thailand, UAE origins. For engineering polymers, model both rates but keep China as primary — no origin has CEPA-level advantage on PA6/PA66/PC/POM/PBT (ABS excepted). Decision trigger dates: If extension notified late May → continue Q2 pattern. If sunset confirmed or by mid-June with no signal → default to sunset assumption, increase Korea/ASEAN share 20-30% on quality-sensitive commodity grades, begin supplier onboarding by May 15 latest.
