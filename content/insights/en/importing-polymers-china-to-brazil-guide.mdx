---
title: "Importing Polymer Resin from China to Brazil: Tariffs, Landed Cost, and What Buyers Need to Know"
date: "2026-03-25"
description: "A practical guide for Brazilian polymer importers covering TEC duties, ICMS, PIS/COFINS, NCM codes, Siscomex procedures, freight from China to Santos, and when Chinese resin undercuts Braskem domestic pricing."
...
**Coal-to-Olefins (CTO):** Coal is converted to methanol and then to ethylene and propylene. Feedstock cost is driven by domestic coal prices, not crude oil. When Brent is above $80/bbl, CTO producers hold a structural cost advantage of approximately $100-150/MT over naphtha crackers. These facilities are located inland (Ningxia, Inner Mongolia) and export through northern ports like Tianjin and Qingdao.
...
For Brazilian buyers, the practical implication is this: the Chinese price advantage is not a subsidy, a dumping strategy, or a temporary overcapacity phenomenon that will self-correct. It is a structural difference in feedstock economics that persists — and in fact widens — when oil prices are elevated. The FOB price gap between Chinese CTO-origin LLDPE and Korean naphtha-origin LLDPE at $100+ Brent is large enough to survive Brazil's 14% TEC, the ICMS/PIS/COFINS stack, and the higher freight cost.
