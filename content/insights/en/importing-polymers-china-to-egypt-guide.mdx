...
faq:
  - question: "What duty do I pay importing Chinese polymers to Egypt?"
    answer: "MFN duty on primary-form polyethylene and polypropylene from China is 5% on CIF value. PVC attracts 2% (Egyptian Customs Decree 59/2020; verify the current rate, as Egypt re-decrees tariffs periodically). Saudi and UAE origin polymers enter at 0% duty under GAFTA. VAT of 14% applies to all origins equally, calculated on CIF value plus duty. The total landed cost burden from China is typically 20-25% above CIF value including duty, VAT, and port charges."
  - question: "Is it cheaper to import polymers from Saudi Arabia or China to Egypt?"
    answer: "It depends on the product. For PE (polyethylene), Saudi origin is often cheaper landed because GAFTA 0% duty compounds an already competitive ethane-based FOB price. For PP (polypropylene) and PVC, Chinese origin frequently delivers lower landed cost because the FOB price advantage from CTO/PDH (PP) and calcium carbide (PVC) production routes exceeds the 2-5% duty gap (5% on PP, 2% on PVC). Run product-specific landed cost calculations rather than applying a single origin strategy."
  - question: "How long does shipping from China to Egypt take?"
    answer: "Transit to Ain Sokhna (Red Sea) is 18-22 days from Shanghai or Ningbo — the shortest China-to-Egypt route because vessels do not need to transit the Suez Canal. Mediterranean ports (Alexandria, Damietta, Port Said) require 25-32 days via Suez. Add 1-2 weeks for customs clearance and inland transport. Total order-to-warehouse cycle is typically 5-8 weeks via Ain Sokhna and 6-9 weeks via Alexandria."
  - question: "Does Egypt have free trade agreements that affect polymer imports?"
    answer: "Egypt's most impactful trade agreement for polymer imports is GAFTA (Greater Arab Free Trade Area), which provides 0% duty on imports from Saudi Arabia, UAE, and other Arab League members. China has no FTA with Egypt. The EU Association Agreement provides some tariff preferences for European-origin polymers. All Chinese-origin polymers pay the full MFN rate. There is no indication of a China-Egypt FTA under negotiation that would change this in the near term."
---
...
|---------|---------|-------------------|------------------------|-----|-------|
| LDPE / LLDPE granules | 3901.10.xx | **5%** | **0%** | 14% | Primary forms, SG below 0.94 |
...
| PVC (unplasticized) | 3904.10.xx | **2%** | **0%** | 14% | Decree 59/2020; verify current rate |
| PVC (plasticized) | 3904.21/22.xx | **2%** | **0%** | 14% | Compounds may attract higher rates |

Key points on Egypt's tariff treatment:

**GAFTA is China's main tariff competitor.** The Greater Arab Free Trade Area provides 0% duty access for Saudi Arabia, UAE, Bahrain, and other Arab League members. This gives SABIC, Borouge, and other Gulf producers a 2-5 percentage point duty advantage over Chinese origin (5% on PE/PP, 2% on PVC). For PE specifically — where Gulf ethane-based producers are already among the world's lowest-cost — the tariff gap compounds an already competitive FOB price.

**The duty is manageable on PP and PVC.** Because China's structural cost advantage is largest in PP (via CTO and PDH routes) and PVC (via the calcium carbide route), the duty gap — 5% on PP, just 2% on PVC — is often fully offset by FOB price differentials. On PE, the calculus is tighter — Gulf producers have both cost and tariff advantages.
...
**EGP devaluation is a procurement variable.** The Egyptian pound has experienced significant depreciation events. For polymer importers, currency movements between order placement and payment execution can significantly affect landed cost. Three risk management approaches are common:
...
MFN duty on primary-form polyethylene and polypropylene from China is 5% on CIF value. PVC attracts 2% (Egyptian Customs Decree 59/2020; verify the current rate, as Egypt re-decrees tariffs periodically). Saudi and UAE origin polymers enter at 0% duty under GAFTA. VAT of 14% applies to all origins equally, calculated on CIF value plus duty. The total landed cost burden from China is typically 20-25% above CIF value including duty, VAT, and port charges.
