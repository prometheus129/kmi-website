...
|---------|---------------|--------|-------|
| PVC suspension | 3904.10 | Provisional measures imposed | Monitor Resmi Gazete for final determination |
| PVC emulsion | 3904.40 | Not currently targeted | Monitor for future actions |

As of early 2026, Turkey has imposed provisional anti-dumping measures on Chinese-origin PVC. PVC importers should monitor *Resmi Gazete* announcements for the final determination, which may establish definitive duties. If the investigation concludes with definitive measures, PVC duty rates would likely fall within a range comparable to PE and PP.
...
**Effective non-recoverable duty = MFN (~6.5%) + AD (5-18%) = approximately 11.5-24.5% of CIF value.**

For the highest-rate scenarios — a non-cooperating Chinese exporter shipping PE or PP at residual rates — the combined MFN + AD burden can approach 24-25% of CIF value. At the lower end, a cooperating Chinese PE exporter may face a combined burden of approximately 11.5-12%.
...
- **If you buy from a cooperating Chinese exporter** with an individually assigned rate, you may pay a significantly lower anti-dumping duty — potentially as low as 5% for some PE exporters, versus the residual rate at the high end of the range (up to 18%).
...
PVC has moved from investigation to provisional measures. Provisional anti-dumping duties have been imposed on Chinese-origin PVC. The final determination — which will set definitive duty rates — is expected in the second half of 2026.

**Practical implication:** PVC importers should incorporate current provisional duty rates into pricing models immediately. If you are sourcing PVC from China, confirm the applicable provisional rate with your customs broker and monitor Resmi Gazete for the final determination.
...
**First, know your actual duty rate.** The difference between a 5% company-specific rate and an 18% residual rate on PE is roughly $130/MT at current CIF levels. That difference is larger than most freight rate variations and most negotiated discounts. Supplier selection — specifically, selecting Chinese exporters with individually assigned lower rates — is one of the highest-value procurement actions available.
