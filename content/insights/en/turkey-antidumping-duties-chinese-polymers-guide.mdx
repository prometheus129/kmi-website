---
title: "Turkey's Anti-Dumping Duties on Chinese Polymers: What Every Importer Needs to Know"
date: "2026-03-25"
description: "A comprehensive guide to Turkey's anti-dumping duties on Chinese PE, PP, and PVC imports. Covers duty rates by HS code, the full cost stack (MFN + AD + KDV), company-specific vs. residual rates, current review timelines, and mitigation strategies for Turkish polymer importers."
...
But the FOB price advantage that draws Turkish buyers to Chinese polymer is not the number that matters. The number that matters is landed cost at Mersin, Ambarlı, or Gemlik — and between the FOB quote and the customs-cleared cost sits a duty stack that can add 19-31% to the CIF value. That stack includes both standard customs duties and anti-dumping duties, and for many mid-tier importers, it is not fully understood.
...
|---------|---------------|---------------------------|-------|
| LLDPE (SG &lt; 0.94) | 3901.10 | ~3-13% | Covers film, injection, and blown film grades |
| LDPE | 3901.10 | ~3-13% | Includes tubular and autoclave process grades |
| HDPE (SG ≥ 0.94) | 3901.20 | ~3-13% | Pipe, blow molding, and injection grades |
| Linear PE (other) | 3901.40 | ~3-13% | Metallocene and other specialty linear PE |

PE anti-dumping measures were established through investigations in the early 2020s. The wide rate range (approximately 3-13%) reflects the spread between company-specific rates for cooperating Chinese exporters and the residual rate applied to non-cooperating or unknown exporters. The residual rate sits near the top of this range.
...
| **Anti-Dumping Duty** | 3-15% (varies) | CIF value | Product-specific and exporter-specific |
...
**Effective non-recoverable duty = MFN (~6.5%) + AD (3-15%) = approximately 9.5-21.5% of CIF value.**

For the highest-rate scenarios — a non-cooperating Chinese exporter shipping PP homopolymer — the combined MFN + AD burden can approach 21-22% of CIF value. At the lower end, a cooperating Chinese PE exporter may face a combined burden of approximately 9.5-10%.
...
- **If you buy from a cooperating Chinese exporter** with an individually assigned rate, you may pay a significantly lower anti-dumping duty — potentially as low as 3-5% for some PE exporters, versus the 13% residual rate.
...
*Detailed guide: See Article 3 in this series — "How to Use Turkey's Inward Processing Regime for Duty-Free Polymer Imports."*
...
*Detailed guide: See Article 2 in this series — "Calculating True Landed Cost: China vs. Alternative Origins for Turkish Polymer Buyers."*
...
**First, know your actual duty rate.** The difference between a 3% company-specific rate and a 13% residual rate on PE is roughly $100/MT at current CIF levels. That difference is larger than most freight rate variations and most negotiated discounts. Supplier selection — specifically, selecting Chinese exporters with individually assigned lower rates — is one of the highest-value procurement actions available.
