...
For daily visibility into where LLDPE C4 pricing actually sits — including Kantor Indicative Prices with directional signals — subscribe to the [The Polymer Compass](/polymer-compass). It is the same pricing intelligence we use to evaluate 600+ merchants on every order, delivered to your inbox before the trading day opens.
