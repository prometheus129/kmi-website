---
title: "Algeria Polymer Import 2026: China PE/PP/PVC Landed Cost + Bank Domiciliation"
date: "2026-03-05"
dateModified: "2026-06-01"
description: "Algeria polymer importers: MFN 5% on Chinese PE/PP, 19% VAT, mandatory bank domiciliation. Full landed cost breakdown for PE, PP, PVC from China to Algiers and Oran."
...
For a detailed analysis of how feedstock economics affect pricing for MENA buyers, see our [CTO/PDH feedstock advantage explainer](/insights/cto-pdh-feedstock-advantage-mena).
...
| PP copolymers | 3902.30.xx | **5%** | **0%** | **0-5%** | 19% | Primary forms |
| PVC (unplasticized) | 3904.10.xx | **5%** | **0%** | **0-5%** | 19% | Higher rates on compounds/finished forms |
...
**Three-tier competition.** Algerian polymer buyers face a three-way tariff landscape: GAFTA origins (0%), EU origins (reduced or 0% under the EU-Algeria Association Agreement), and Chinese origin (full MFN). This is more complex than Egypt, where the primary competition is bilateral (China vs. GAFTA). European origins — particularly from Spain, France, and Belgium — are meaningful competitors in Algeria because of the Association Agreement. Turkey also competes through a separate bilateral trade arrangement with Algeria.

**VAT at 19% is among the highest in North Africa.** Algeria's VAT rate exceeds Egypt's 14% and is close to Morocco's 20%. Combined with MFN duty, total landed cost from Chinese origin is typically 25-35% above CIF value. Algeria also levies a customs formality fee (TCS, around 3%) and a solidarity contribution (PRCT, around 2%) on imports, which push landed cost toward the upper end of that range — confirm current rates with your customs broker.
...
**Rate verification is critical.** Algeria's tariff schedule can be complex, with rates varying by specific subheading and form. Additionally, Algeria applies supplementary import levies — notably the Provisional Safeguard Duty (DAPS), which targets finished and semi-finished plastic articles rather than primary-form resins — and revises them periodically. Always confirm the current applicable rate with Algerian customs (Direction Generale des Douanes) or a licensed customs broker before finalizing pricing.
...
This illustrative example shows the core duty, VAT, and handling stack for importing PP homopolymer from China to Algiers (TCS and PRCT levies add a few percentage points beyond this). All prices are representative CFR market assessments — actual prices vary by grade, volume, and market conditions.
...
For more on China's PVC production economics, see our [CTO/PDH feedstock advantage analysis for MENA](/insights/cto-pdh-feedstock-advantage-mena).
...
MFN duty on primary-form PE and PP from China is 5% on CIF value. PVC and PP copolymers attract 5% in primary form (some compounds and finished forms carry higher rates). Finished plastic articles can attract 15-30%. Saudi and UAE origin enters at 0% under GAFTA. EU origin enters at 0-5% under the EU-Algeria Association Agreement. VAT of 19% applies to all origins, calculated on CIF value plus duty. Total landed cost from China is typically 25-35% above CIF value.
