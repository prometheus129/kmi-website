---
title: "Iranian/Saudi Polymer Substitution 2026: Chinese PE, PP, PVC Replacement Grades"
date: "2026-04-17"
dateModified: "2026-04-27"
description: "Iranian and Saudi polymer supply impaired since April 2026. Grade-by-grade Chinese substitution map: which Iranian and SABIC PE/PP/PVC grades have Chinese equivalents, with named producers, specs, and freight to Vietnam, Indonesia, Turkey, India."
...
PA6 substitution matters for Turkish automotive (Bursa supply chain) and Indian automotive (Chennai/Pune/Gurugram clusters). Iranian and Saudi PA6 are not significant export streams, so this segment is more about redirecting away from BASF Ultramid or Envalior Akulon if the broader Middle East / European supply chain tightens. Chinese Sinopec Baling grades (BL3200, BL3240, YH800) are the most widely used.
...
**Regulatory watchlist.** Indonesia has NO anti-dumping duty in force on PP homopolymer from China — it is an open KADI investigation (initiated December 2024, HS 3902.10.40, covering 8 origins including China), with proposed duties in the 5.52%-36.62% range that have not been enacted. Do not price a PP anti-dumping duty into current landed cost; treat it as a downside risk to monitor at kadi.kemendag.go.id. HDPE and LLDPE from China face no anti-dumping duties and no active investigation. The one in-force Indonesian AD measure on a China-origin polymer product is on BOPP film (finished film, not PP resin) under PMK 60/2024 (5.76%-29.95%).
...
**Destination port and freight.** Shanghai → Nhava Sheva is the primary route at 18-25 days transit; Shanghai → Mundra is similar. Chennai and Kolkata routing via Colombo transhipment adds 5-10 days. Indicative freight is in the $70-110/MT range (sourcing team confirmation recommended).
...
| Indonesia | ACFTA | Form E | 0% (PP homopolymer BMAD under KADI investigation, not yet in force) | N/A (Iran not in ACFTA — MFN) |
...
**For Vietnam and Indonesia specifically, the substitution to Chinese origin is duty-favorable**: both markets grant 0% ACFTA tariff on Chinese polymer under Form E, versus the 3-5% MFN rate Iranian origin typically attracts. Indonesian PP homopolymer carries a watch item — a KADI anti-dumping investigation (proposed 5.52-36.62%, not yet enacted) that could add duty if finalized — but no PP anti-dumping duty is in force today, so the 0% ACFTA advantage applies in full for now.

### Sourcing documentation checklist

For each substitution order, the destination buyer should receive from the Chinese producer via the sourcing team:
...
5. **Manufacturer's commercial invoice** (not a trading-company invoice — for AD exporter identification in Turkey the named producer on the invoice matters today, and if Indonesia's PP homopolymer BMAD investigation finalizes with company-specific rates the named producer would matter there too).
...
Forward the Iranian, Saudi, or Borouge grade designation on your purchase order and your destination port — the sourcing team will return matched Chinese alternatives with current CFR pricing, named producer, freight, and documentation details. For buyers with multiple grade positions at risk simultaneously, the output is a consolidated substitution matrix covering the full basket, prioritized by substitution match quality and delivered-cost delta.
