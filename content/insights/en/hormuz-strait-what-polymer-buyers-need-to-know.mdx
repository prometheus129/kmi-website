...
**Priority substitution segments.** Engineering polymer compounds (PA6, PA66, PC, ABS, POM, PBT) are the wider Lane 2 opportunity in India given no ADD across the full engineering polymer range and the nil-BCD window. For commodity substitution of Iranian/Saudi volumes, LLDPE (DFDA-7042 equivalent) and HDPE blow molding (5502/5000S equivalent) are the highest-priority near-term switches.
