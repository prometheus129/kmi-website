...
**Feedstock cost advantage.** Chinese producers operating on coal-to-olefin (CTO) and propane dehydrogenation (PDH) routes produce PE and PP at structurally lower variable cost than naphtha-dependent producers when crude oil prices are elevated. Note: for PE specifically, Middle Eastern ethane-based production costs are comparable to or lower than CTO — China's feedstock advantage is most pronounced on PP. For a detailed analysis, see our [CTO/PDH feedstock advantage explainer](/insights/en/cto-pdh-naphtha-feedstock-advantage-resin-prices).

**Supply breadth.** China's polymer export market involves over 1,600 producers and more than 600 active trading merchants. This depth provides grade selection and competitive pricing that no single Middle Eastern producer can match across all applications. Our [Chinese producer landscape guide](/insights/en/china-polymer-producers-guide) maps the key producers by feedstock route and product specialization.
