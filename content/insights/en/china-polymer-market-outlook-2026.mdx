...
Chinese PE exports to ASEAN have grown year-on-year since 2022, and 2026 is poised to continue the trend. Domestic demand growth for PE in China is running at approximately 3-4% annually, while capacity growth is outpacing demand by 2-3 percentage points. The arithmetic is straightforward: surplus volume seeks export outlets, and ASEAN is the easiest route due to ACFTA zero-tariff access, short transit times, and established trading relationships.
...
The net effect: unless oil drops below $60/bbl (which would compress the CTO/PDH advantage) or coal/propane costs spike significantly, China's feedstock cost advantage persists through 2026 and likely beyond.
...
For mid-tier distributors and converters purchasing 20-200 MT per month, the depth of Chinese supply means allocation risk is low. The optimization opportunity is timing — even a $20-30/MT improvement in average purchase price across annual volume translates to significant savings at scale.
