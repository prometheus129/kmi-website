...
faq:
  - question: "How much duty do I pay on polymer imports in Kenya?"
    answer: "Primary-form polymer resins (HS 3901-3908) enter Kenya at 0% under the EAC Common External Tariff 2022, which classifies them as raw materials. The cost at the border comes from the other levies: Import Declaration Fee 3.5%, Railway Development Levy 2.0%, and VAT at 16% on the cumulative total. The all-in landed burden — levies, VAT, PVoC fees, and port charges — typically reaches approximately 21-24% above CIF value, and VAT is recoverable for registered businesses. No preferential tariff rates exist for Chinese origin; all origins pay the same EAC CET rates. A few specialty polymers (poly(vinyl acetate), acrylics, unsaturated polyesters) sit at 10% — confirm your exact HS code against the current KRA tariff."
...
The total landed cost burden typically reaches approximately **21-24% above CIF value** when levies and VAT are included — and VAT is recoverable for registered businesses, so the non-recoverable burden is lighter still. This makes accurate cost modeling essential before committing to purchase orders. The IDF and RDL are sometimes overlooked by first-time importers — together they add 5.5 percentage points before VAT.
...
**2. Underestimating the total landed cost burden.** Primary-form resins are duty-free, but first-time importers often forget IDF (3.5%), RDL (2.0%), and the compounding effect of VAT (16%) on the levy-inclusive total. The actual burden is approximately 21-24% above CIF — not zero. Model the full cost stack before quoting to downstream customers.
...
Primary-form polymer resins (HS 3901-3908) enter Kenya at 0% under the EAC Common External Tariff 2022, which classifies them as raw materials. The cost at the border comes from the other levies: Import Declaration Fee 3.5%, Railway Development Levy 2.0%, and VAT at 16% on the cumulative total. The all-in landed burden — levies, VAT, PVoC fees, and port charges — typically reaches approximately 21-24% above CIF value, and VAT is recoverable for registered businesses. No preferential tariff rates exist for Chinese origin; all origins pay the same EAC CET rates. A few specialty polymers (poly(vinyl acetate), acrylics, unsaturated polyesters) sit at 10% — confirm your exact HS code against the current KRA tariff.
