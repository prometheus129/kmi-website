...
- **Typical flexural modulus:** ~1,500 MPa (class indicator; verify against current LG TDS for commercial commitment)
- **Typical notched Izod (23°C):** ~5 kJ/m²
...
| Typical flexural modulus | ~1,500 MPa | ~1,400–1,500 MPa | ~1,500–1,650 MPa (nucleation effect) |
| Typical notched Izod (23°C) | ~5 kJ/m² | ~4–5 kJ/m² | ~4–5 kJ/m² |
...
- **Typical tensile strength (dry as molded):** ~200 MPa
- **Typical flexural modulus (dry):** ~9,500 MPa
- **Heat deflection temperature (1.82 MPa):** ~250°C
...
| Tensile strength (dry) | ~200 MPa | ~170–200 MPa (compounder-dependent) |
| Flexural modulus (dry) | ~9,500 MPa | ~8,500–9,500 MPa (compounder-dependent) |
| HDT at 1.82 MPa | ~250°C | ~240–255°C |
...
**Kingfa Sci. & Tech. (Guangzhou, Guangdong).** Publicly listed (Shenzhen Stock Exchange) specialty compounding house. Extensive PA66-GF, PA6-GF, and other engineering compound ranges. Significant R&D base; credible for OEM-qualified compounds.
