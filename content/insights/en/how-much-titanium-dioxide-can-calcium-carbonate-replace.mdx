...
faq:
  ...
  - question: "Is calcium carbonate a titanium dioxide substitute, an alternative, or an extender?"
    answer: "An extender — not a substitute or an alternative. A substitute would do titanium dioxide's actual job, hiding, and calcium carbonate cannot: its refractive index (about 1.6) sits too close to the polymer's to scatter much light. An extender lets you use less of the pigment while the product still meets its whiteness and opacity spec. So a search for a 'TiO₂ replacement', a 'titanium dioxide alternative', or a 'TiO₂ extender' all land on the same honest answer — you can take part of the loading out, often 10–30% on a white line, but never all of it. Anyone offering a full one-for-one replacement is selling physics that does not exist."
---
