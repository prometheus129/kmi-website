...
This example compares landed cost at Cat Lai (HCMC) for 22 MT of raffia-grade PP. Korean HY301 is the incumbent; Sinopec T30S is the substitute. Numbers are April 2026 indicative.

| Cost Component | Korean HY301 (Yeosu → HCMC) | Chinese T30S (Guangzhou → HCMC) |
|---|---|---|
