---
title: "India's Anti-Dumping Duty on Vietnamese Calcium Carbonate Masterbatch: Why Importers Are Switching to Raw GCC Powder (2026)"
slug: "india-vietnam-calcium-carbonate-filler-masterbatch-add-raw-powder-2026"
date: "2026-06-05"
dateModified: "2026-07-12"
description: "India's anti-dumping duty on Vietnamese calcium carbonate filler masterbatch runs US$ Nil–75/MT — with a countervailing duty up to US$69.19/MT recommended June 2026 on top. Neither touches raw GCC powder (HS 2836.50, 0% under AIFTA with Form AI). Why Indian compounders are switching to raw powder, and how to choose a grade."
...
India's Directorate General of Trade Remedies (DGTR) and the CBIC acted against Vietnamese filler masterbatch in two steps:
...
So the logical response is: import the raw powder (HS 2836.50), compound the masterbatch in India, and keep the duty off the bill. The economics favour it, and India already imports more Vietnamese calcium carbonate than any other country. *(One honest caveat: this is the rational response to the duty, and early signs point to it, but the full scale of the shift is still building — treat it as the direction, not a settled statistic.)* What the switch actually demands of your line — powder handling, dosing, dispersion, incoming QC — and when staying on masterbatch is the right choice, is covered in [the switching guide](/insights/india-switch-masterbatch-to-gcc-powder-compounding).
...
**The key point:** filler masterbatch for plastics uses **GCC** — bulk cost-filling is its job. PCC is not "better"; it is for a different purpose. For an Indian converter lowering cost on sacks, film, or pipe, the path is GCC — as raw powder (if you compound in-house) or as masterbatch (if you don't). With the masterbatch now dutied from Vietnam, the raw-powder route is the one that has changed in your favour.
...
**Vietnam vs India's domestic GCC — the honest picture.** India is **not** short of calcium carbonate: it has a substantial domestic industry across Rajasthan, Gujarat and Andhra Pradesh, and for many grades domestic powder is the right, lower-freight choice. The gap the imported Vietnamese grade fills is **specific, not general**: India's largest domestic producers cap around **93% ISO brightness** and do not target food/pharma, whereas the premium Vietnamese tier — very fine (around **1250 mesh**), high-whiteness (approaching **98%**), stearic-coated — serves white film, food/pharma fillers, and premium masterbatch. The case for importing is that top specification plus the AIFTA-0% powder route and a single supplier for resin and filler — **not** a claim that one origin's quarry is categorically superior.
