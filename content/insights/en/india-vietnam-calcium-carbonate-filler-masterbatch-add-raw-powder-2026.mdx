...
- **Countervailing-duty investigation — pending, deadline set.** India has separately **initiated a countervailing-duty (CVD) probe** on the same Vietnamese masterbatch. No CVD has been imposed yet — final findings are due by **26 June 2026** following a Central Government extension (status as of June 11, 2026) — but the direction of travel is clear: the finished-masterbatch route from Vietnam is being squeezed from two sides.
