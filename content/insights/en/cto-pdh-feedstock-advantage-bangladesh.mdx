...
faq:
  - question: "Why is Chinese polymer cheaper than Indian or Korean resin?"
    answer: "Chinese polymer producers use CTO (coal-based) and PDH (propane-based) feedstocks, which are less sensitive to oil prices than naphtha. India and Korea are almost entirely naphtha-dependent. When oil is above $70/bbl, this differential can reach $50-150/MT."
  - question: "What are CTO and PDH?"
    answer: "CTO (Coal-to-Olefins): Coal is gasified to produce methanol, then converted via MTO to ethylene and propylene. Commercially viable only in China. PDH (Propane Dehydrogenation): Propane is converted to propylene and then polymerized into PP. Produces PP only, not PE."
  - question: "Do wholesale plastic prices in Bangladesh rise when oil prices increase?"
    answer: "From Indian and Korean sources, yes — naphtha-route producers' prices rise in direct proportion to oil. From Chinese CTO/PDH sources, the impact is significantly lower. This is why Chinese sources are most competitive when oil prices are rising."
  - question: "Is this feedstock advantage permanent?"
    answer: "The current infrastructure represents decades of investment — replication by any other country would require at least 10-15 years. However, the advantage compresses if oil falls below $50/bbl or if Chinese coal prices spike abnormally."
---
