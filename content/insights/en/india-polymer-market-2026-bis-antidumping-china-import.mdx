...
India's import barriers — 8.25% effective duty (BCD 7.5% + Social Welfare Surcharge), anti-dumping duties on PVC, and expanding BIS certification requirements — are the highest of any major Asian polymer market. But China still supplies a significant share of India's imports. The question is: where?
...
**The PVC contrast — when ADD applies:** The same calculation for PVC SG-5 from China adds an anti-dumping duty of approximately $50-120/MT (varies by exporter) on top of the 8.25% effective BCD. This pushes PVC landed cost $50-120/MT higher than HDPE — and yet China still supplies approximately 40% of India's PVC imports, because domestic capacity cannot meet demand even at this elevated price.
...
## Import Barriers: BIS Certification, Anti-Dumping Duties, and Tariff Structure
...
**PP and PE from China — No confirmed active ADD, but investigations underway**

As of April 2026, there are no confirmed active anti-dumping duties on PP or bulk PE specifically from China. However, DGTR initiated anti-dumping investigations on LLDPE, HDPE, and PP imports from China in 2024, with preliminary and final findings reportedly in progress. If ADD duties are imposed on Chinese PE and PP, it would materially change the cost structure for China-origin polyolefins entering India. Monitor DGTR notifications closely — this is the most significant emerging trade barrier for Chinese polymer exports to India.
