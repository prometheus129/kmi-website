...
**The critical insight:** When crude oil is in the $60-70/bbl range, CTO production costs are roughly competitive with naphtha cracking. But when oil rises above $80/bbl, CTO producers begin to develop a meaningful cost advantage. At current levels above $100/bbl, industry estimates suggest CTO producers hold an estimated $100-150 per metric ton of headroom relative to naphtha-based competitors, based on the differential between CTO cash costs and naphtha-route cash costs at current oil prices — meaning they can cut prices significantly and still maintain healthy margins.
