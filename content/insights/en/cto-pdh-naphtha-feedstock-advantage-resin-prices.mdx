---
title: "Why Chinese PE/PP Costs $50-120/MT Less: CTO and PDH Feedstock Math"
date: "2026-03-01"
dateModified: "2026-04-27"
description: "China's coal-to-olefins (CTO) and propane dehydrogenation (PDH) deliver PE and PP at $50-120/MT below naphtha-based Korean and Saudi competitors. The feedstock math, with delivered-cost examples for SE Asian buyers."
author: "Kantor Materials Research"
tags: ["why Chinese polymer is cheaper", "China polymer cost advantage", "China resin price advantage explained", "feedstock", "cto", "pdh", "naphtha", "china", "polymers", "resin-prices", "southeast-asia", "cost-structure", "China PE price", "China PP price"]
faq:
  - question: "Why is Chinese PE and PP cheaper than Korean or Middle Eastern polymer?"
    answer: "China produces polymers from three feedstock routes — coal-to-olefins (CTO/MTO), propane dehydrogenation (PDH), and naphtha cracking — while Korea, Japan, Taiwan, and most Middle Eastern producers depend almost entirely on naphtha. CTO and PDH costs are decoupled from crude oil. When Brent sits above $80/bbl, CTO producers hold an estimated $80–150/MT cash-cost headroom over naphtha-route competitors, and PDH holds an estimated $50–80/MT. The price gap is structural, not cyclical."
  - question: "What is coal-to-olefins (CTO) and which Chinese producers use this route?"
    answer: "Coal-to-olefins gasifies coal into syngas, converts it to methanol, then processes it through methanol-to-olefins (MTO) technology to produce ethylene and propylene for PE and PP. Major CTO producers include Shenhua (China Energy Group), Baofeng Energy (宝丰能源), Ningmei (宁煤), and Zhongtian Hechuang (中天合创). Plants run 600,000–1,000,000 tonnes per year of polyolefin capacity. Most operate on long-term coal supply agreements or own their mines, so feedstock cost is largely fixed regardless of crude oil. Geographic constraint: CTO plants are inland (Ningxia, Inner Mongolia) — roughly 1,500 km from export ports."
  - question: "What is propane dehydrogenation (PDH) and how does it differ from CTO?"
    answer: "PDH dehydrogenates imported propane (primarily from US, Middle East, Australia) to produce propylene, which is then polymerized into polypropylene. PDH is a propylene-only route — it does not produce ethylene or PE. Major Chinese PDH producers include Jinneng Technology (金能科技, Shandong), Donghua Energy (东华能源, Zhejiang), and Juzhenyuan (巨正源, Guangdong). Unlike CTO, PDH plants are coastal — Ningbo, Qingdao, Shekou/Nansha — minimizing inland transport and shortening transit to Southeast Asian ports. PDH economics track propane prices, which correlate with oil but imperfectly thanks to the US shale propane surplus."
  - question: "How does oil price affect the Chinese polymer cost advantage?"
    answer: "At $60–70/bbl, CTO and naphtha cracking costs are roughly competitive; PDH holds a slight advantage. At $80+/bbl, the gap widens — every $10/bbl increase in crude raises naphtha-route production cost by an estimated $25–40/MT while leaving CTO costs essentially unchanged and PDH costs dampened. At $100+/bbl, CTO holds approximately $100–150/MT headroom, PDH holds $50–80/MT. As long as oil remains above $70–80/bbl and Chinese coal remains inexpensive, Chinese PE and PP producers operate on a fundamentally lower cost curve than naphtha-dependent competitors."
  - question: "Why is Chinese PVC different from Chinese PE and PP?"
    answer: "Roughly 72–75% of China's PVC uses the calcium carbide route: coal is converted to calcium carbide in electric arc furnaces, reacts with water to produce acetylene, then converts to VCM and PVC. This is fundamentally different from ethylene-route PVC produced by Formosa, Shin-Etsu, Kaneka, and most Western producers. Calcium-carbide PVC follows coal and electricity economics rather than oil economics. Cost is typically lower than ethylene-route when oil is above $70/bbl, but the process is energy-intensive and may contain trace mercury catalyst residues. For sensitive applications — medical-grade, food-contact, high-specification cable insulation — some buyers specify ethylene-route only."
  - question: "How do I identify which feedstock route a Chinese polymer producer uses?"
    answer: "If the producer name includes Shenhua, Baofeng (宝丰), Ningmei (宁煤), or Zhongtian Hechuang (中天合创), the product is CTO-route. If it includes Jinneng (金能), Donghua (东华), or Juzhenyuan (巨正源), it is PDH. Major state-owned brands — Sinopec, PetroChina, CNOOC — are predominantly naphtha, though some operate mixed-feed crackers. Knowing the route tells you the producer's price-floor risk: in a falling market, CTO and PDH producers can sustain lower prices for longer than naphtha-based competitors. Also check port of origin — CTO ships from Tianjin/Qingdao, PDH from Ningbo/Pearl River Delta — freight differential to SE Asia can be $10–25/MT."
---
...
**The critical insight:** When crude oil is in the $60-70/bbl range, CTO production costs are roughly competitive with naphtha cracking. But when oil rises above $80/bbl, CTO producers begin to develop a meaningful cost advantage. When oil rises above $100/bbl, industry estimates suggest CTO producers hold an estimated $100-150 per metric ton of headroom relative to naphtha-based competitors, based on the differential between CTO cash costs and naphtha-route cash costs — meaning they can cut prices significantly and still maintain healthy margins. At $70-80/bbl, the advantage is more moderate ($80-120/MT) but still structurally meaningful.
...
| **Cost advantage at $100+ oil** | ~$100-150/MT estimated headroom vs. naphtha cash costs | ~$50-80/MT estimated headroom | Baseline (squeezed margins) |
...
**2. A sustained oil-price spike.** When Brent rises above $80-100/bbl, it widens the gap between CTO/PDH costs and naphtha costs. Every $10/bbl increase in crude oil prices raises naphtha-route production costs by an estimated $25-40/MT (crude +$10/bbl raises naphtha roughly $8-10/MT, which cascades through cracking yields and energy costs) while leaving CTO costs essentially unchanged. PDH costs rise, but at a dampened rate. For buyers, this means Chinese-origin resin prices are structurally more stable during oil-price volatility than Korean or Middle Eastern alternatives.
...
For Philippine buyers, the calculus is similar but transit times are longer in all cases. Manila is roughly equidistant from Ningbo and Nansha by sea, so the northern-port freight penalty is less pronounced than it is for Vietnam.
...
### Why is Chinese PE and PP cheaper than Korean or Middle Eastern polymer?
China produces polymers from three feedstock routes — coal-to-olefins (CTO/MTO), propane dehydrogenation (PDH), and naphtha cracking — while Korea, Japan, Taiwan, and most Middle Eastern producers depend almost entirely on naphtha. CTO and PDH costs are decoupled from crude oil. When Brent sits above $80/bbl, CTO producers hold an estimated $80–150/MT cash-cost headroom over naphtha-route competitors, and PDH holds an estimated $50–80/MT. The price gap is structural, not cyclical.

### What is coal-to-olefins (CTO) and which Chinese producers use this route?
Coal-to-olefins gasifies coal into syngas, converts it to methanol, then processes it through methanol-to-olefins (MTO) technology to produce ethylene and propylene for PE and PP. Major CTO producers include Shenhua (China Energy Group), Baofeng Energy (宝丰能源), Ningmei (宁煤), and Zhongtian Hechuang (中天合创). Plants run 600,000–1,000,000 tonnes per year of polyolefin capacity. Most operate on long-term coal supply agreements or own their mines, so feedstock cost is largely fixed regardless of crude oil. Geographic constraint: CTO plants are inland (Ningxia, Inner Mongolia) — roughly 1,500 km from export ports.

### What is propane dehydrogenation (PDH) and how does it differ from CTO?
PDH dehydrogenates imported propane (primarily from US, Middle East, Australia) to produce propylene, which is then polymerized into polypropylene. PDH is a propylene-only route — it does not produce ethylene or PE. Major Chinese PDH producers include Jinneng Technology (金能科技, Shandong), Donghua Energy (东华能源, Zhejiang), and Juzhenyuan (巨正源, Guangdong). Unlike CTO, PDH plants are coastal — Ningbo, Qingdao, Shekou/Nansha — minimizing inland transport and shortening transit to Southeast Asian ports. PDH economics track propane prices, which correlate with oil but imperfectly thanks to the US shale propane surplus.

### How does oil price affect the Chinese polymer cost advantage?
At $60–70/bbl, CTO and naphtha cracking costs are roughly competitive; PDH holds a slight advantage. At $80+/bbl, the gap widens — every $10/bbl increase in crude raises naphtha-route production cost by an estimated $25–40/MT while leaving CTO costs essentially unchanged and PDH costs dampened. At $100+/bbl, CTO holds approximately $100–150/MT headroom, PDH holds $50–80/MT. As long as oil remains above $70–80/bbl and Chinese coal remains inexpensive, Chinese PE and PP producers operate on a fundamentally lower cost curve than naphtha-dependent competitors.

### Why is Chinese PVC different from Chinese PE and PP?
Roughly 72–75% of China's PVC uses the calcium carbide route: coal is converted to calcium carbide in electric arc furnaces, reacts with water to produce acetylene, then converts to VCM and PVC. This is fundamentally different from ethylene-route PVC produced by Formosa, Shin-Etsu, Kaneka, and most Western producers. Calcium-carbide PVC follows coal and electricity economics rather than oil economics. Cost is typically lower than ethylene-route when oil is above $70/bbl, but the process is energy-intensive and may contain trace mercury catalyst residues. For sensitive applications — medical-grade, food-contact, high-specification cable insulation — some buyers specify ethylene-route only.

### How do I identify which feedstock route a Chinese polymer producer uses?
If the producer name includes Shenhua, Baofeng (宝丰), Ningmei (宁煤), or Zhongtian Hechuang (中天合创), the product is CTO-route. If it includes Jinneng (金能), Donghua (东华), or Juzhenyuan (巨正源), it is PDH. Major state-owned brands — Sinopec, PetroChina, CNOOC — are predominantly naphtha, though some operate mixed-feed crackers. Knowing the route tells you the producer's price-floor risk: in a falling market, CTO and PDH producers can sustain lower prices for longer than naphtha-based competitors. Also check port of origin — CTO ships from Tianjin/Qingdao, PDH from Ningbo/Pearl River Delta — freight differential to SE Asia can be $10–25/MT.
...
Understanding the feedstock behind the price is the first step toward making procurement decisions based on structural economics rather than spot-market instinct. To see how these feedstock economics translate into real specification and quality differences on a specific grade, see [PP T30S: Sinopec vs. PetroChina vs. CTO — Producer Comparison](/insights/pp-t30s-sinopec-petrochina-cto-comparison), which maps naphtha, PDH, and CTO producers to MFI consistency and impurity profiles for China's most-traded PP grade.

---

*For current China-origin pricing, [tell us what you need](/inquiry) — polymer type, application, volume, and destination — and our sourcing team will respond with matched grades and current FOB pricing.*

*Not ready to submit a requirement? [Subscribe to daily pricing updates](/polymer-compass) — current FOB pricing updated every trading day.*
