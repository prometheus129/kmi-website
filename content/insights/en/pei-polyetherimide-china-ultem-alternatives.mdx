...
**Overhead structure.** Polymerization, compounding, and testing in China operate at lower total cost than equivalent operations in Saudi Arabia (SABIC) or the United States (legacy GE Plastics sites). This is not a quality statement — it is a manufacturing economics fact.
