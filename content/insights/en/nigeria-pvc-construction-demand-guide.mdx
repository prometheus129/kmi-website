...
faq:
  ...
  - question: "What is the landed cost of PVC polymer import to Nigeria?"
    answer: "PVC resin (uncompounded suspension PVC, HS 3904.10) attracts 5% ECOWAS CET duty — the same rate as PE and PP. When combined with VAT (7.5%), CISS (1%), and other levies, the total landed cost burden on PVC resin imports is approximately 15-21% of CIF value, comparable to PE and PP. Note that pre-compounded PVC or plasticized PVC products attract higher duty rates (10-20%), so Nigerian processors generally benefit from importing uncompounded resin and compounding locally."
  - question: "Will Dangote produce PVC?"
    answer: "As of early 2026, Dangote's announced petrochemical capacity is focused on PE (approximately 1.5 million t/y) and PP (approximately 900,000 t/y). No large-scale PVC production project has been publicly announced. Nigeria's PVC supply will likely continue to depend on imports for the foreseeable future. Any future domestic PVC resin producer would avoid the 5% CET import duty, giving it a structural cost advantage over imported supply."
---
...
For an overview of polymer demand across all Nigerian sectors — including oil and gas, packaging, and agriculture — see our [Nigeria polymer demand analysis](/insights/nigeria-polymer-demand-oil-gas-packaging-construction).
...
Understanding the tariff structure for PVC imports into Nigeria is essential for accurate landed cost planning.
...
| PVC resin (suspension/emulsion, primary forms) | 3904.10.xx | Band 2 | **5%** |
| PVC compounds and plasticized PVC | 3904.21/22.xx | Band 3/4 | **10-20%** |
| PVC articles and finished goods | Various Chapter 39 | Band 4 | **20%+** |

**PVC resin in primary forms (HS 3904.10) attracts the same 5% CET as PE and PP.** The higher rates (10-20%) apply to PVC compounds (pre-mixed with plasticizers, stabilizers, fillers) and plasticized PVC products — not to uncompounded suspension PVC resin. For Nigerian pipe and profile manufacturers buying S-PVC resin to compound in-house, the import duty rate is 5%.

When combined with VAT (7.5%), CISS (1%), and other levies, the total landed cost burden on PVC resin imports is approximately 15-21% of CIF value — comparable to PE and PP.

**What this means for PVC importers:**

**Buy resin, not compound, to minimize duty exposure.** Nigerian PVC processors who import pre-compounded PVC (with plasticizers and stabilizers already mixed in) face 10-20% CET rather than 5%. Importing uncompounded S-PVC resin and compounding locally preserves the lower duty rate and provides more control over formulation.

**Domestic production economics.** Any future domestic PVC resin producer would avoid the 5% CET entirely — the same advantage that domestic PE and PP producers hold over imports. Monitor announcements for potential PVC projects.

**Grade selection and working capital.** While the duty rate for PVC resin equals PE and PP, PVC transactions still carry working capital cost proportional to unit prices. Ordering the correct K-value grade from the outset avoids rework costs. Verify K-value specifications against your pipe or profile standard before placing orders.

For a full breakdown of Nigeria's import duty structure and landed cost modeling, see our [Nigeria polymer import guide](/insights/importing-polymers-china-to-nigeria-guide).
...
**Practical impact:** A full elimination of the 13% export rebate on PVC would increase effective FOB prices by approximately 10-13% (the rebate is calculated on the tax-inclusive domestic price). For Nigerian buyers already facing 10-20% CET duty plus VAT and levies, this would significantly change the landed cost comparison between Chinese PVC and alternative origins.

For context on how Chinese feedstock economics affect polymer pricing more broadly, see our [CTO/PDH feedstock advantage analysis](/insights/cto-pdh-feedstock-advantage-nigeria).
...
PVC resin (uncompounded suspension PVC, HS 3904.10) attracts 5% ECOWAS CET duty — the same rate as PE and PP. When combined with VAT (7.5%), CISS (1%), and other levies, the total landed cost burden on PVC resin imports is approximately 15-21% of CIF value, comparable to PE and PP. Note that pre-compounded PVC or plasticized PVC products attract higher duty rates (10-20%), so Nigerian processors generally benefit from importing uncompounded resin and compounding locally.
