...
**A note on brand names:** several of the Western lines above have changed ownership, so a datasheet may carry an old or a new company name for the same grade. Most recently, SABIC's engineering-thermoplastics business in the Americas and Europe — its Lexan (PC), Cycoloy (PC/ABS), and Valox (PBT) lines — is being sold to Mutares SE, expected to close in the second half of 2026; earlier, DuPont's Zytel and Crastin lines moved to Celanese (2022). Match on the grade specification, not the company name — the material itself is unchanged.
