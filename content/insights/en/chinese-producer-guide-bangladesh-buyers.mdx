...
tags: ["bangladesh", "polymers", "chinese-producers", "supplier-guide", "sinopec", "petrochina", "procurement", "pe", "pp", "pvc", "hdpe", "lldpe", "china-polymer-export-bangladesh", "chittagong-port", "plastic-raw-materials-bangladesh", "apta"]
---
...
Approximately 72–75% of Chinese PVC is produced via the calcium carbide route. This is suitable for pipe, conduit, and general profile applications. However, for transparent products, medical packaging, or applications requiring high thermal stability, specify ethylene-route PVC (from Sinopec subsidiaries or Taiwanese Formosa).
