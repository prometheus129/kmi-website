---
title: "Chinese PA6 2026: Shenma, Sinopec, Kingfa, Remay Compound Sourcing"
date: "2026-05-05"
dateModified: "2026-05-05"
description: "Chinese PA6 producer comparison for engineering polymer buyers: Shenma base resin, Sinopec commodity, Kingfa IATF compounding, Remay custom compounds for SE Asia."
author: "Kantor Materials Research"
tags: ["pa6", "nylon-6", "shenma", "sinopec", "kingfa", "remay", "engineering-polymers", "engineering polymers", "compounding", "automotive", "producer-comparison", "lane-2"]
faq:
  - question: "What is the difference between PA6 base resin and PA6 compound?"
    answer: "PA6 base resin is the unmodified polymer (nylon 6) — produced by polymerizing caprolactam. Pure PA6 has high moisture absorption, moderate stiffness, and limited heat resistance, so most engineering applications use PA6 compounds — base resin combined with glass fiber, mineral fillers, impact modifiers, flame retardants, heat stabilizers, or color masterbatches. Chinese supply splits cleanly between base-resin producers (Shenma, Sinopec Yizheng, Sumika Polymer Compounds China, BASF Yizheng) and compounders (Kingfa, Wanma, Remay, plus 100+ smaller compounders). For specification-driven applications, the compounder identity matters more than the base resin source."
  - question: "Which Chinese producers make PA6 base resin?"
    answer: "Shenma Group (Pingdingshan, Henan) is the largest Chinese PA66 producer and also produces PA6, leveraging vertical integration from caprolactam to base resin. Sinopec Yizheng (Jiangsu) is the long-established commodity PA6 producer, supplying both fiber-grade and engineering-grade base resin. PetroChina also produces PA6. International joint ventures including BASF-Yizheng, Sumika Polymer Compounds China, and DSM China produce premium grades. For commodity-grade base resin, Shenma and Sinopec Yizheng cover the bulk of domestic and export demand."
  ...
  - question: "What are Chinese equivalents to DuPont Zytel 101 (PA66 unfilled)?"
    answer: "DuPont Zytel 101 is unfilled PA66 (nylon 66) — note that this article focuses on PA6 (nylon 6), which has different properties than PA66. For PA6 unfilled equivalents to general-purpose engineering nylon, Shenma BL3200H, Sinopec Yizheng EPR-24, and Kingfa Vican PA6 unfilled grades cover the application range. For direct DuPont Zytel substitutes, see our Lane 2 article on PA66 alternatives. The PA6 vs. PA66 choice depends on application — PA6 is more flexible, easier to process, and lower cost; PA66 has higher heat resistance and stiffness."
...
### Sinopec Yizheng (Jiangsu)

The longest-established Chinese commodity PA6 producer, dating to early 1990s. Naphtha-based caprolactam supply chain.

- Capacity: substantial (estimates vary, several hundred thousand tons/year combined fiber + engineering)
- Grades: EPR series for engineering, plus extensive fiber-grade portfolio
...
**International joint ventures** — BASF-Yizheng, Sumika Polymer Compounds China, DSM China — produce specialty grades, often higher-spec engineering applications. Pricing reflects the JV brand premium.
...
- Volume is large enough (50+ MT/month) to negotiate direct from Shenma or Yizheng
...
**Textile fibers** (low-flow PA6, fiber-grade): Base resin route. Shenma and Sinopec Yizheng are the standard sources.
...
**India:** The Bureau of Indian Standards (BIS) Quality Control Order on PA6/PA66 was rescinded in early 2026, removing a previously significant non-tariff barrier for Chinese PA6 imports. India is now a substantially more accessible market for Chinese engineering nylon — verify current import conditions with your Indian buyer or customs broker before quoting.
...
1. Specific producer and grade — "Shenma BL3200H" or "Sinopec Yizheng EPR-24"
...
**For compound orders:**
1. Compounder name and grade designation — "Kingfa Vican PA6-GF30 V0" or "Remay [internal grade ID]"
...
|---|---|---|---|
| Chinese commodity (Shenma, Yizheng) | 1,800-2,100 | 2,200-2,500 | 2,800-3,200 |
...
|---|---|---|
| Textile fiber base resin | Shenma BL3200H or Sinopec Yizheng | Viscosity, COA each lot |
| General housings (no FR, no GF) | Sinopec Yizheng EPR-24 base resin or Kingfa unfilled | Tensile strength dry-and-conditioned |
| Cable ties (impact-modified PA6) | Kingfa Vican IM-grade or Remay custom | Notched Izod at -20°C |
...
BASF Ultramid B3K (PA6 unfilled, MFI medium) and Lanxess Durethan B30S (PA6 unfilled) are European reference grades for general-purpose engineering nylon. For direct substitution, Shenma BL3200H and Sinopec Yizheng EPR-24 cover the same application window at significantly lower CIF — typically $400-700/MT below European spot. The trade-offs: European base resin offers tighter molecular weight distribution and more uniform additive packages; Chinese base resin is improving but may show batch-to-batch variation. For cost-driven applications (general housings, gears, low-stress mechanical parts), Chinese substitution is straightforward. For specification-critical applications (precision gears, electrical components requiring tight UL ratings, automotive structural), pilot trials and supplier qualification through a compounder like Kingfa or Remay reduce switching risk.
