...
faq:
  ...
  - question: "What is the cost difference between Chinese PA6 and Korean or European PA6?"
    answer: "Chinese PA6 base resin typically prices $400-700/MT below Korean (Hyosung, Kolon) and European (BASF, Lanxess) equivalents on commodity grades. The gap reflects (1) caprolactam feedstock availability — China produces a substantial share of global caprolactam, (2) lower processing energy costs, and (3) less brand-premium pricing. For compounded grades (GF30, FR, impact-modified), the gap narrows to $200-400/MT — additive costs are globally traded commodities while labor and overhead differences narrow but don't eliminate the spread. The cost-saving opportunity is largest on commodity unfilled PA6 and narrowest on heavily specified Tier 1 OEM compounds."
  - question: "What is the Chinese equivalent to Ultramid B3EG6, Durethan BKV30, or Zytel 73G30 (PA6-GF30)?"
    answer: "There is no drop-in identity, but the class match for all of them is a 30% glass-fiber-reinforced PA6 — the standard reinforced nylon-6 grade for housings, brackets, fan components, and structural parts. Ultramid B3EG6 (BASF), Durethan BKV30 (Envalior, formerly Lanxess), Akulon K224-G6 (Envalior, formerly DSM), and Zytel 73G30 (Celanese, formerly DuPont) are all PA6-GF30 grades in the same class, available from a Chinese compounder such as Kingfa (volume, IATF-certified) or Remay (custom). Match the glass loading and the stabilizer package before you order: a heat-stabilized grade (Ultramid B3WG6, Durethan BKV30H2.0, Zytel 73G30HSL) needs a heat-stabilized Chinese class, and a halogen-free flame-retardant grade (Durethan BKV30FN04) needs an FR class with the UL94 rating verified on the specific grade's UL Yellow Card. Because PA6 absorbs moisture, confirm whether your current grade's stiffness and strength figures are dry-as-molded or conditioned, and compare the candidate on the same basis."
---

> **Summary:** PA6 (nylon 6) is the default engineering polymer for moderate-stress mechanical, electrical, and consumer applications. Chinese supply splits between base-resin producers (Shenma, Sinopec Baling) and compounders (Kingfa for volume-standard, Remay for custom OEM-specification). Cost gap to European/Korean: $400-700/MT on commodity grades. For automotive Tier 1 supply, IATF 16949-certified compounders are the qualifying path — Kingfa is the largest Chinese option; Remay (KMI's Lane 2 partner) is the OEM-validated specialty alternative for BYD/CATL-grade specifications.
...
- Grades: EPR-series PA66 resin grades (e.g. EPR27) plus commodity PA6 grades, various fiber-grade variants
...
Specialty engineering compounder, 20,000+ MT/year capacity across 16 automated production lines, QCS-certified testing center generating 1M+ data points/year.
...
### When to Choose Kingfa Over Remay
...
- **Volume is large.** Annual purchase volumes above ~50 MT per spec where standard catalog formulations fit. Kingfa's economies of scale produce a $200-400/MT cost advantage on commodity GF30 / FR-rated / impact-modified PA6 grades.
...
- **IATF 16949 is the deciding requirement.** Kingfa is IATF certified across multiple production lines; Remay's IATF status varies by grade. For Tier 1 OEM AVL pathways where IATF is the qualifying gate, Kingfa is the lower-friction path.
...
- **Tighter lot-to-lot consistency** is the deciding requirement, particularly for low-volume specification-critical applications.
...
**The moisture sensitivity is the dominant processing variable.** PA6 must be dried to below 0.2% moisture before melt processing. Insufficient drying produces splay, brittleness, and molecular weight degradation. Compounders pre-dry pellets and ship in moisture-barrier bags; converters re-dry before molding.

## When Does Chinese PA6-GF30 Match Western References?

PA6-GF30 — 30% glass-fiber-reinforced nylon 6 — is the standard reinforced grade for housings, brackets, fan components, and structural parts that do not need PA66's higher heat resistance. Three of the reference brands below changed ownership since 2020 — Durethan and Akulon both moved into Envalior (the April 2023 Lanxess–DSM engineering-materials merger), and Zytel moved from DuPont to Celanese (November 2022) — so you may see the same grade listed under either the old or new producer name. Match on the grade designation, not the producer name on the datasheet.

| Reference Grade | Producer (current) | Composition | Chinese Substitution Path |
|---|---|---|---|
| Ultramid B3EG6 | BASF | PA6-GF30, general purpose | Catalog-standard GF30 class — Kingfa or Remay |
| Ultramid B3WG6 | BASF | PA6-GF30, heat-aging stabilized | Heat-stabilized GF30 class — match the heat-stabilizer package |
| Durethan BKV30 | Envalior (formerly Lanxess) | PA6-GF30, general purpose | GF30 class — Kingfa or Remay |
| Durethan BKV30H2.0 | Envalior (formerly Lanxess) | PA6-GF30, heat-stabilized | Heat-stabilized GF30 class |
| Durethan BKV30FN04 | Envalior (formerly Lanxess) | PA6-GF30, halogen-free flame retardant | Halogen-free FR GF30 class — match FR chemistry, verify the UL Yellow Card |
| Akulon K224-G6 | Envalior (formerly DSM) | PA6-GF30 | GF30 class — Kingfa or Remay |
| Zytel 73G30 / 73G30HSL | Celanese (formerly DuPont) | PA6-GF30 (73G30HSL adds heat stabilizer + lubricant) | GF30 class — Kingfa or Remay; if your grade is HSL, match the heat-stabilized/lubricated package |

Every row above is a composition-and-application match — the correct starting point, not a substitution guarantee. Match the glass loading and the stabilizer package (general-purpose vs. heat-stabilized vs. flame-retardant) to your current grade before the pilot trial. One check deserves attention with PA6: because nylon 6 absorbs a lot of moisture, a datasheet's stiffness and strength depend heavily on whether the values are dry-as-molded or conditioned — compare your current grade and the candidate on the same basis, then qualify with a sample and molding trial before committing volume.
...
**India:** India's Ministry of Chemicals and Fertilizers rescinded a set of polymer Quality Control Orders (BIS QCOs) in November 2025 covering PE, PP, PVC, ABS, EVA, PU, and PC — but **PA6 and PA66 were not in that list**. Engineering polyamides may face other import compliance requirements depending on end-use sector. Verify current import conditions with your Indian buyer or customs broker before quoting.
...
4. Moisture specification on shipment — "below 0.4%, sealed packaging"
...
The cost advantage is largest on commodity unfilled grades and narrowest on heavily specified compounds — because compounding cost (additives, processing energy, QC) is similar globally regardless of base-resin origin.
...
### What is the Chinese equivalent to Ultramid B3EG6, Durethan BKV30, or Zytel 73G30 (PA6-GF30)?
