...
The origin comparison above uses illustrative prices. The real calculation requires today's FOB and CIF data across all four corridors. The Polymer Compass provides daily Chinese polymer pricing and origin comparison signals — the inputs you need to run this analysis with live numbers. [Subscribe to The Polymer Compass](/terminal) or [contact our research desk](/contact) for buyer-specific landed cost modeling.
