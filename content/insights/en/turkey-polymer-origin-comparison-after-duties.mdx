...
- **Polyethylene (HDPE, LDPE, LLDPE):** 3--13%, depending on grade and producer. Cooperating exporters identified during the original investigation receive lower individual rates; non-cooperating or unreviewed exporters face the residual rate at or near the top of the range.
...
**Combined effective rate:** For a typical non-cooperating Chinese PE exporter, the combined duty burden (MFN plus anti-dumping) falls in the range of 15--20%. For PP, this can reach 15--22%. At the upper end --- where a buyer sources from an unreviewed Chinese exporter facing the residual anti-dumping rate --- the effective combined duty on PP can approach 28--31%.
...
**The buyer sources from a cooperating Chinese exporter.** Individually determined anti-dumping rates (typically 3--10%) versus the residual rate (13--18%) translate to $80--100 per metric ton in savings on a $1,000 CIF shipment.
