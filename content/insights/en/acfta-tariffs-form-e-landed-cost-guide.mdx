---
title: "Vietnam Polymer Import 2026: ACFTA Form E, 0% Duty, Landed Cost"
date: "2026-03-10"
dateModified: "2026-04-18"
description: "Vietnam PE, PP, PVC import guide: ACFTA 0% duty qualification, Form E requirements and rejection risks, total landed cost calculation versus Korean and Saudi origin."
...
|---------|---------|--------------------------|----------------------|-----------|
| LLDPE granules (SG below 0.94) | 3901.10.92 | 2% | **0%** | 0% |
...
**Third,** note Vietnam's trade-defense position on PE. Effective 8 July 2025, Vietnam imposed a new 2% MFN safeguard-type duty on HDPE and LLDPE imports to protect domestic producer Long Son Petrochemical. Critically, this is an MFN measure — a valid Form E still zeroes it for China-origin resin, so the ACFTA 0% outcome holds for Chinese HDPE and LLDPE. Imports without a valid Form E (or from non-ACFTA origins) pay the 2%. (This should not be confused with the Philippines, which moved the opposite way around the same time — the Philippine authorities suspended an HDPE safeguard duty in September 2025.) For commodity PP and PVC from China, no additional anti-dumping or safeguard duties apply as of Q1 2026. This can change — monitor Vietnam's Ministry of Industry and Trade (MOIT) trade remedy announcements quarterly.
...
| Ocean freight (Ningbo → HCMC, 40HQ) | ~$47/MT | Included |
| **Subtotal at discharge port** | **~$1,247/MT** | **$1,247/MT** (if CFR quote) |

In this example, a CFR HCMC quote of $1,250/MT and an FOB Ningbo quote of $1,200/MT represent nearly identical economics — the CFR quote simply bundles the ~$47/MT freight.

But freight costs vary significantly by origin port. The same grade loaded at Dalian instead of Ningbo adds roughly $14/MT to freight ($61/MT vs. $47/MT for HCMC delivery). A northern China producer quoting the same FOB price as a Zhejiang producer is not offering the same delivered cost. Always convert to CFR at your destination port before comparing quotes.

**Key freight ranges for reference (April 2026, 40HQ container, all-in including port charges):**

| Origin | To HCMC | To Hai Phong |
|--------|---------|-------------|
| Guangzhou/Nansha | ~$36/MT | — |
| Ningbo | ~$47/MT | ~$38/MT |
| Qingdao | ~$54/MT | ~$40/MT |
| Tianjin | ~$54/MT | ~$45/MT |
| Dalian | ~$61/MT | ~$61/MT |

Rates are sourcing team all-inclusive (ocean + port charges at ¥1,900-2,000 RMB). Guangzhou is the cheapest route to HCMC. Rates increased approximately $9/MT across all routes in April 2026.

Hai Phong is consistently cheaper than HCMC for ocean freight, and South China ports (Guangzhou, Shenzhen) offer the shortest and cheapest routes. If your factory is in the north, Hai Phong delivery from Qingdao or Tianjin can save $10-15/MT versus HCMC.

To run these calculations with current market data, [see today's China-origin indicative pricing for PE, PP, and PVC](/pricing).
...
| Ocean freight + origin charges | $1,036 | ~$47 |
| Destination terminal handling | $195 | ~$9 |
| Container imbalance surcharge (EBS/CIC) | $100 | ~$5 |
| B/L + D/O fees | $100 | ~$5 |
| Customs clearance (broker + fees) | $150 | ~$7 |
| Marine insurance (0.2% CIF, ICC "A") | $57 | ~$3 |
| Import duty (ACFTA Form E = 0%) | $0 | $0 |
| VAT (8% on CIF + duty) | ~$2,155 | ~$98 |
| **Total landed cost** | **~$29,093** | **~$1,324/MT** |

The gap between FOB $1,150 and landed $1,324 is $174/MT — a 15.1% uplift. Of that, roughly $47 is freight, $29 is port and documentation charges, and $98 is VAT (which is recoverable for VAT-registered businesses as input tax credit). Note: Vietnam's standard VAT rate is 10%, but a temporary reduction to 8% has been extended through 2026.

**Excluding recoverable VAT, the effective landed uplift is approximately $76/MT, or 6.6% above FOB.**

This is the number that matters for cost comparison. When a Korean supplier quotes CFR HCMC at $1,250/MT for an equivalent grade, the Korean landed cost includes 0-5% import duty under the Vietnam-Korea FTA (VKFTA) — meaning Korean CFR $1,250 lands at approximately $1,250-1,313/MT before VAT depending on grade-specific VKFTA rates. A Chinese supplier quoting FOB Ningbo at $1,150/MT lands at roughly $1,226/MT before VAT (0% duty under ACFTA, freight at current April 2026 rates). The Chinese advantage on an apples-to-apples landed basis is approximately $24-87/MT depending on the applicable Korean duty rate. At 500 MT/year, even the narrower gap represents $12,000 in annual savings. Note: Middle Eastern origins without a preferential FTA pay the full 2% MFN rate on PP, landing higher than both Chinese and Korean alternatives on equivalent CFR pricing. For HDPE and LLDPE specifically, non-preferential origins also incur Vietnam's 2% safeguard duty (effective 8 July 2025) on top of MFN — a burden a valid Form E removes for China-origin resin.
...
The difference between a good China-origin polymer price and a good landed cost is execution. The tariff advantage is real — 0% under ACFTA versus 2-3% MFN — but it only materializes when the paperwork is correct, the freight route is optimized, and every cost component is accounted for before the order is placed. For grade-level pricing and specification context, see [PP T30S: Sinopec vs. PetroChina vs. CTO — Producer Comparison](/insights/pp-t30s-sinopec-petrochina-cto-comparison) and [HDPE 5000S vs. 5502 vs. 7260: Grade Selection Guide](/insights/hdpe-5000s-5502-7260-grade-selection).

---

*This guide reflects ACFTA tariff schedules, Vietnam customs procedures, and freight market conditions as of April 2026. Tariff rates, trade defense measures, and freight surcharges are subject to change. Confirm current rates with your customs broker and freight forwarder before each shipment.*
