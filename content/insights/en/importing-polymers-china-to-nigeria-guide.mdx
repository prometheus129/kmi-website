...
For a deeper analysis of how these feedstock routes affect pricing, see our [CTO/PDH feedstock advantage explainer](/insights/en/cto-pdh-feedstock-advantage-nigeria).

Three additional factors reinforce China as a primary sourcing origin for Nigerian buyers:

**Supply breadth.** China's polymer export market involves over 1,600 producers and more than 600 active trading merchants. For mid-tier Nigerian distributors and converters purchasing 20-200 MT per month, this depth offers grade selection and competitive pricing that no single alternative origin can match. Our [Chinese producer landscape guide](/insights/en/chinese-producer-guide-nigeria-buyers) maps the key producers by feedstock route and product specialization.
