...
date: "2026-04-03"
description: "Vietnam imports 80-85% of its polymer resin. Domestic producers cover only PP — and even that is fragile. See which PE, PP, and PVC grades Vietnamese converters need most."
...
## Vietnam: 80-85% Import Dependent — and Domestic Production Is Fragile

Vietnam consumes an estimated 8.5-9 million metric tons of virgin polymer resin per year — PP, PE (HDPE, LLDPE, LDPE), PVC, PET, and engineering polymers. Only 15-20% of that is produced domestically. The rest is imported, making Vietnam one of the most import-dependent polymer markets in Asia.
...
|---|---|---|---|---|
| Hyosung Vina Chemicals | Cai Mep, Ba Ria-Vung Tau | 600,000 | PP homo | Operational. Reported USD 72M loss in H1 2025. |
| Long Son Petrochemicals (SCGC) | Ba Ria-Vung Tau | 400,000 PP + 500,000 HDPE + 500,000 LLDPE | PP, HDPE, LLDPE | Restarted Aug 2025 after 10-month shutdown. USD 304M loss in 2024. |
| NSRP (Nghi Son) | Thanh Hoa | 370,000-400,000 | PP homo | Operational |
...
**Total nameplate PP capacity: ~1.5 million MT/year.** But actual production is lower — Hyosung and Long Son both lost money and Long Son was shut for 10 months in 2024-2025 when naphtha spreads compressed below breakeven (~USD 350/MT). Realistic output is closer to 850,000-1,000,000 MT/year.
...
**What Long Son means for importers:** Even at full nameplate capacity (1.4 MT/year of HDPE, LLDPE, and PP combined), Long Son would cover only ~15-20% of Vietnam's total resin demand. Vietnam would still need to import 5+ million MT per year. And Long Son produces only commodity polyolefins — it competes directly with Chinese CTO/MTO producers who have their own structural cost advantage. For PVC, engineering polymers, and specialty grades, Long Son changes nothing.

## Import Structure: Who Supplies What

Vietnam's import dependency varies dramatically by polymer family. This is critical for understanding where China competes and where it doesn't.

### PP Imports — China Is Now #1

Vietnam imported approximately USD 1.13 billion of PP in 2024 from around 1,700 importers. China supplied roughly 40% by value — making Vietnam China's #1 PP export destination globally.

**Why China dominates PP:** CTO/MTO feedstock economics. China's coal-to-olefins and methanol-to-olefins routes produce PP at structurally lower cost than naphtha-based Korean, Japanese, or Middle Eastern competitors — typically USD 50-120/MT cheaper on an FOB basis. Combined with ACFTA 0% tariff and short South China Sea transit (Guangzhou to HCMC: 2-5 days), China-origin PP is the most competitive supply for the vast majority of Vietnamese converter requirements.

**Top PP suppliers to Vietnam (2024):**
1. China (~40% share, ~USD 450M)
...
Vietnam imported approximately USD 1.38 billion of PE in 2024. Unlike PP, PE imports are dominated by Saudi Arabia and Singapore — not China.

**Why:** Vietnam had zero domestic PE production until Long Son's brief 2024 startup. Middle Eastern and Singaporean refiners established supply chains years ago, and Saudi PE benefits from ethane-based feedstock economics that are globally competitive. However, China is gaining PE market share as CTO/MTO capacity expands and Chinese producers push export volumes into ASEAN under ACFTA.
...
|---|---|---|---|
| Packaging | ~50% | LLDPE, PP, HDPE, PVC | FMCG growth, e-commerce, export packaging for electronics |
| Construction | ~25% | PVC, HDPE, PP | Infrastructure spending (+40% YoY in H1 2025), water and drainage pipe |
| Electronics assembly | Significant | PE film, PP, ABS, PC | Samsung (50% of global smartphones made in Vietnam), Foxconn, LG, Pegatron |
| Textiles and garments | Significant | PP woven, LLDPE film | Vietnam is a top-5 global garment exporter. PP woven bags, FIBC, garment packaging |
...
| Shanghai to HCMC | 5-8 days | Major route for East China producers |
| Ningbo to HCMC | 6-9 days | Zhejiang/Jiangsu producer route |
| Ningbo to Hai Phong | 7-10 days | Northern Vietnam route |
...
Vietnam consumes an estimated 8.5-9 million metric tons of virgin polymer resin per year, based on import volumes (~6.8 MT in 2023) plus domestic production (~1.5-2 MT). Market research firms cite higher figures (11-12 MT) but these typically include finished plastic products, not just virgin resin.

### What percentage of polymer does Vietnam import?

Approximately 80-85% of virgin polymer resin consumed in Vietnam is imported. Domestic production covers primarily PP (from Hyosung Vina, Long Son, NSRP, and BSR) and a portion of PVC. HDPE, LLDPE, PET, and engineering polymers are almost entirely imported.

### Who are Vietnam's domestic polymer producers?

Hyosung Vina Chemicals (600K MT PP), Long Son Petrochemicals/SCGC (400K PP + 500K HDPE + 500K LLDPE — but fragile economics), NSRP/Nghi Son (370-400K PP), BSR/Dung Quat (150K PP), and TPC Vina + AGC Vietnam (~390K PVC combined). Total nameplate PP capacity is ~1.5 MT/year but actual output is lower due to economics.
...
Not significantly in the near term. Even at full nameplate capacity (1.4 MT/year), Long Son would cover only 15-20% of Vietnam's total polymer demand. The complex was offline for 10 months in 2024-2025 due to poor naphtha spreads. A USD 500M ethane conversion project (expected late 2027) could improve its competitiveness, but Vietnam's demand growth of 8%+ per year means absolute import volumes will continue rising regardless.
