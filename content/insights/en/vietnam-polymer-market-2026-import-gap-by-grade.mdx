...
Vietnam imported approximately USD 11.8 billion of plastics and plastic raw materials (HS Chapter 39) in 2024, up 20.7% from 2023. China is the dominant supplier for PP and PVC. For PE, Saudi Arabia and Singapore lead — but China is gaining share as CTO/MTO economics and ACFTA tariffs tilt the cost equation.
...
**Key grades:** PVC SG-5 from Chinese carbide-route producers (Xinjiang Tianye, Shandong Haihua). HDPE 5000S/HE3490 for pipe applications. For a guide to selecting between Chinese HDPE grades 5000S, 5502, and 7260 --- including the common naming trap between 5502AA (blow molding) and 5502GA (injection) --- see [HDPE 5000S vs. 5502 vs. 7260: Grade Selection Guide](/insights/hdpe-5000s-5502-7260-grade-selection).

### Electronics Assembly

Vietnam hosts the largest concentration of electronics manufacturing FDI in Southeast Asia. Samsung produces over 50% of its global smartphones in Vietnam (Bac Ninh and Thai Nguyen). Foxconn, Pegatron, LG, and Intel all operate major facilities.
...
**Note on quality variance:** T30S is a commodity designation used by both Sinopec and PetroChina across multiple subsidiaries. Quality consistency between plants (Yanshan, Maoming, Lanzhou, Daqing) varies. Specify isotactic index of 96% or above and request a Certificate of Analysis with each shipment. For a detailed comparison of T30S across Chinese producers by feedstock pathway, see [PP T30S: Sinopec vs. PetroChina vs. CTO — Producer Comparison](/insights/pp-t30s-sinopec-petrochina-cto-comparison).
