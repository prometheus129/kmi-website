...
description: "India's anti-dumping duty on Vietnamese calcium-carbonate filler masterbatch runs US$ Nil–75/MT depending on the producer. What each rate means for your sourcing, why Form AI does not shield you from the ADD, the full duty build-up (ADD sits inside the IGST base), and the countervailing duty recommended in June 2026 on top."
...
## Nil Is Not Immunity: The CVD Is Now Recommended
...
|---|---|
| Buying from the Nil-rated producer's named channel | No ADD today — but a US$13.42/MT CVD is recommended for that producer (imposition expected by ~late September 2026); price it in, and don't sign long commitments that assume Nil is permanent |
