---
title: "Importing Polymer Resin from China to Mexico: Tariffs, USMCA Dynamics, and Landed Cost Analysis"
date: "2026-03-25"
description: "A practical guide for Mexican polymer buyers covering MFN tariffs, IVA, customs procedures, USMCA competition from US resin, and when Chinese-origin PE and PP still wins on landed cost at Manzanillo and Lazaro Cardenas."
...
The CTO advantage at elevated oil prices can put Chinese FOB prices $100-150/MT below US Gulf prices for equivalent grades. After adding the freight differential (~$15-25/MT more for China to Pacific coast) and the 3% duty (~$33/MT on CIF), the Chinese CTO-origin product can still arrive $50-90/MT cheaper than US-origin.
...
The price gap between Chinese and US polymer resin is not the result of subsidies, dumping, or temporary overcapacity. It reflects a fundamental difference in production chemistry.
...
For a Mexican buyer, the practical takeaway is that the Chinese FOB price advantage is durable and structural. It does not depend on currency manipulation, government subsidies, or predatory pricing. It depends on chemistry and geology — coal in Ningxia and propane from US shale are fundamentally cheaper feedstocks than naphtha at $100+ oil. This advantage persists through trade cycles and is likely to widen if oil prices remain elevated.
