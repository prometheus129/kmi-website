...
Coal-to-olefin producers represent the lowest-cost tier of China's polymer production. Their cost advantage is most pronounced when crude oil prices are above $80/bbl. For a detailed explanation of CTO economics, see our [CTO/PDH feedstock advantage analysis](/insights/en/cto-pdh-feedstock-advantage-nigeria).
...
- **Document consistency** is critical for Nigerian customs clearance. Ensure the supplier can produce documents where product descriptions, HS codes, quantities, and values match exactly across all documents. See our [import guide](/insights/en/importing-polymers-china-to-nigeria-guide) for common documentation errors.
