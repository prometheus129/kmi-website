...
|---|---|---|---|---|
| PE (HDPE/LDPE/LLDPE) | Active (approx. 3--13%) | Sunset review underway | Extension through ~2030--2031 | Decision expected 2025--2026 |
...
The difference between an individually determined anti-dumping rate (typically 3--10%) and the residual rate (13--18%+) translates to $70--100+ per metric ton in duty savings. Over meaningful volumes, this dwarfs the effort required to identify and work with cooperating exporters.
