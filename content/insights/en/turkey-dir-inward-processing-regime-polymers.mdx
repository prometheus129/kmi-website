---
title: "How Turkish Converters Import Chinese Polymer Duty-Free: The Inward Processing Regime Explained"
date: "2026-03-25"
description: "Turkey's Dahilde İşleme Rejimi (DIR) lets converters import Chinese polymer with zero customs duty and zero anti-dumping duty. This guide covers eligibility, the application process, conversion ratios, common pitfalls, and why DIR makes Chinese resin the lowest-cost option for export-oriented Turkish plastics manufacturers."
...
Chinese commodity polymers — polyethylene, polypropylene, PVC — face a cumulative duty burden of roughly 25-31% when imported into Turkey through standard channels. MFN customs duty at 6.5%, anti-dumping duties ranging from 3% to 25% depending on the product and exporter, and 20% KDV calculated on the compounded base. As [Article 2](/insights/turkey-chinese-polymer-landed-cost-calculator) in this series demonstrates, a $1,000/MT CIF shipment of Chinese HDPE can cost $1,500 or more at the warehouse gate once the full duty stack is applied.
...
**Anti-dumping duty (Dampinge Karşı Vergi).** Whatever anti-dumping rate applies to the specific Chinese exporter or product — whether 3%, 12%, 18%, or 25% — is fully suspended. This is the most significant savings component, because anti-dumping duties are the single largest cost adder for Chinese-origin polymer in Turkey.
...
Understanding when DIR applies and when standard duties apply is central to optimizing polymer procurement costs in Turkey. The regime does not eliminate the duty challenge for domestic sales, but for export-oriented production, it transforms Chinese resin from an uncompetitive option into the lowest-cost origin available. Combined with the landed cost analysis in [Article 2](/insights/turkey-chinese-polymer-landed-cost-calculator) and the anti-dumping framework in [Article 1](/insights/turkey-anti-dumping-chinese-polymers-overview), Turkish converters have the tools to make informed sourcing decisions across their full production mix.
